...
?>
										...
										<tr bgcolor="<?=$altbg2?>" class="tablerow">
											<td><a href="cp2.php?action=delete_theme&amp;themesname=<?=$themeinfo[name]?>">Delete</a></td>
...
if($action == "delete_attachment") {
	...
	echo "<tr bgcolor=\"$altbg2\"><td align=\"center\"><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"$tablewidth\" align=\"center\"><tr bgcolor=\"$altbg1\"><td><div align=\"center\">Deleted ...</td></tr></table>";
}

if($action == "delete_theme") {
	$db->query("DELETE FROM $table_themes WHERE name='$themesname'");
	echo "<tr bgcolor=\"$altbg2\"><td align=\"center\"><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"$tablewidth\" align=\"center\"><tr bgcolor=\"$altbg1\"><td><div align=\"center\">Deleted ...</td></tr></table>";
}
?> 
</table> 
