...
if($status == "Administrator") {
	if($action == "templates" && $download) {
		...
		while ($template=$db->fetch_array($templates)) {
			...
			$code.= "$template[name]|#*XMB TEMPLATE*#|$template[template]|#*XMB 
TEMPLATE FILE*#|";
		}
...
<td align="center">
<a href="cp.php?action=settings"><?=$lang_textsettings?></a> - <a 
href="cp.php?action=forum"><?=$lang_textforums?></a> -
<a href="cp.php?action=mods"><?=$lang_textmods?></a> - <a 
href="cp.php?action=members"><?=$lang_textmembers?></a> -
<a href="cp.php?action=ipban"><?=$lang_textipban?></a> - <a 
href="cp.php?action=upgrade"><?=$lang_textupgrade?></a><br />

<a href="cp2.php?action=themes"><?=$lang_themes?></a> - <a 
href="cp2.php?action=smilies"><?=$lang_smilies?></a> -
<a href="cp2.php?action=censor"><?=$lang_textcensors?></a> - <a 
href="cp2.php?action=ranks"><?=$lang_textuserranks?></a> -
<a href="cp2.php?action=newsletter"><?=$lang_textnewsletter?></a> - <a 
href="cp2.php?action=prune"><?=$lang_textprune?></a> -
<a href="cp2.php?action=templates"><?=$lang_templates?></a> - <a 
href="cp2.php?action=attachments"><?=$lang_textattachman?></a>
<?
//Get All Plugins
...
<td><input type="checkbox" name="delete<?=$themeinfo[name]?>" 
value="<?=$themeinfo[name]?>" /></td>
<td><input type="text" name="name<?=$themeinfo[name]?>" 
value="<?=$themeinfo[name]?>" /> <a 
href="cp2.php?action=themes&single=<?=$themeinfo[name]?>"><?=$lang_textdetails?></a> 
- <a 
href="cp2.php?action=themes&download=<?=$themeinfo[name]?>"><?=$lang_textdltheme?></a></td>
</tr>
...
<tr bgcolor="<?=$altbg1?>" class="tablerow">
<td colspan="3"><a 
href="cp2.php?action=themes&single=anewtheme1"><?=$lang_textnewtheme?></a></td>
</tr>

</table>
</td></tr></table>
<center><input type="submit" name="themesubmit" 
...
<center><input type="submit" name="importubmit" 
value="<?=$lang_textimportsubmit?>" /></center>
</form>
</td>
</tr>
...
if($name != $themes[name]) {
$db->query("UPDATE $table_members SET theme='$name' WHERE 
theme='$themes[name]'");
$db->query("UPDATE $table_forums SET theme='$name' WHERE 
theme='$themes[name]'");
}

$db->query("UPDATE $table_themes SET name='$name' WHERE 
name='$themes[name]'");
}


echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_themeupdate</td></tr>";
}
...
<td colspan="2"><input type="text" name="namenew" 
value="<?=$themestuff[name]?>" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textbgcolor?></td>
<td><input type="text" name="bgcolornew" value="<?=$themestuff[bgcolor]?>" 
/></td>
...
<td><input type="text" name="altbg1new" value="<?=$themestuff[altbg1]?>" 
/></td>
...
<td><input type="text" name="altbg2new" value="<?=$themestuff[altbg2]?>" 
/></td>
...
<td><input type="text" name="bordercolornew" 
value="<?=$themestuff[bordercolor]?>" /></td>
<td bgcolor="<?=$themestuff[bordercolor]?>">&nbsp;</td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textheader?></td>
<td><input type="text" name="headernew" value="<?=$themestuff[header]?>" 
/></td>
...
<td><input type="text" name="headertextnew" 
value="<?=$themestuff[headertext]?>" /></td>
...
<td><input type="text" name="catcolornew" value="<?=$themestuff[catcolor]?>" 
/></td>
<td bgcolor="<?=$themestuff[catcolor]?>">&nbsp;</td>
</tr>
<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textcattextcolor?></td>
<td><input type="text" name="cattextnew" value="<?=$themestuff[cattext]?>" 
/></td>
...
<td><input type="text" name="tabletextnew" 
value="<?=$themestuff[tabletext]?>" /></td>
...
<td colspan="2"><input type="text" name="borderwidthnew" 
value="<?=$themestuff[borderwidth]?>" size="2" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textwidth?></td>
<td colspan="2"><input type="text" name="tablewidthnew" 
value="<?=$themestuff[tablewidth]?>" size="3" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textspace?></td>
<td colspan="2"><input type="text" name="tablespacenew" 
value="<?=$themestuff[tablespace]?>" size="2" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textfont?></td>
<td colspan="2"><input type="text" name="fnew" 
value="<?=$themestuff[font]?>" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textbigsize?></td>
<td colspan="2"><input type="text" name="fsizenew" 
value="<?=$themestuff[fontsize]?>" size="4" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_textboardlogo?></td>
<td colspan="2"><input type="text"  value="<?=$themestuff[boardimg]?>" 
name="boardlogonew" /></td>
</tr>

<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_imgdir?></td>
<td colspan="2"><input type="text"  value="<?=$themestuff[imgdir]?>" 
name="imgdirnew" /></td>
</tr>
<tr bgcolor="<?=$altbg2?>" class="tablerow">
<td><?=$lang_smdir?></td>
<td colspan="2"><input type="text"  value="<?=$themestuff[smdir]?>" 
name="smdirnew" /></td>
</tr>

</table>
</td></tr></table>
<center><input type="submit" value="<?=$lang_textsubmitchanges?>" 
/></center>
...
$db->query("UPDATE $table_themes SET name='$namenew', bgcolor='$bgcolornew', 
altbg1='$altbg1new', altbg2='$altbg2new', link='$linknew', 
bordercolor='$bordercolornew', header='$headernew', 
headertext='$headertextnew', top='$topnew', catcolor='$catcolornew', 
tabletext='$tabletextnew', text='$textnew', borderwidth='$borderwidthnew', 
tablewidth='$tablewidthnew', tablespace='$tablespacenew', 
fontsize='$fsizenew', font='$fnew', boardimg='$boardlogonew', 
imgdir='$imgdirnew', smdir='$smdirnew', cattext='$cattextnew' WHERE 
name='$orig'");
...
if($single == "submit" && $newtheme) {
$db->query("INSERT INTO $table_themes VALUES('$namenew', '$bgcolornew', 
'$altbg1new', '$altbg2new', '$linknew', '$bordercolornew', '$headernew', 
'$headertextnew', '$topnew', '$catcolornew', '$tabletextnew', '$textnew', 
'$borderwidthnew', '$tablewidthnew', '$tablespacenew','$fnew','$fsizenew', 
'$boardlogonew', '$imgdirnew', '$smdirnew', '$cattextnew')");
...
<?
$query = $db->query("SELECT * FROM $table_smilies WHERE type='smiley' ORDER 
BY id");
while($smilie = $db->fetch_array($query)) {
?>

<tr>
<td bgcolor="<?=$altbg2?>" class="tablerow"><input type="checkbox" 
name="delete<?=$smilie[id]?>" value="<?=$smilie[id]?>" /></td>
<td bgcolor="<?=$altbg2?>" class="tablerow"><input type="text" 
name="code<?=$smilie[id]?>" value="<?=$smilie[code]?>" /></td>
<td bgcolor="<?=$altbg2?>" class="tablerow"><input type="text" 
name="url<?=$smilie[id]?>" value="<?=$smilie[url]?>" /></td>
<td bgcolor="<?=$altbg2?>" class="tablerow"><img 
src="<?=$smdir?>/<?=$smilie[url]?>" /></td>
</tr>

<?
}
?>
<tr><td bgcolor="<?=$altbg2?>" colspan="4"><img 
src="./images/pixel.gif"></td></tr>
<tr bgcolor="<?=$altbg1?>" class="tablerow">
...
<?
$query = $db->query("SELECT * FROM $table_smilies WHERE type='picon' ORDER 
BY id");
while($smilie = $db->fetch_array($query)) {
?>
...
<td bgcolor="<?=$altbg2?>" class="tablerow"><input type="checkbox" 
name="delete<?=$smilie[id]?>" value="<?=$smilie[id]?>" /></td>
<td colspan="2" bgcolor="<?=$altbg2?>" class="tablerow"><input type="text" 
name="url<?=$smilie[id]?>" value="<?=$smilie[url]?>" /></td>
<td bgcolor="<?=$altbg2?>" class="tablerow"><img 
src="<?=$smdir?>/<?=$smilie[url]?>" /></td></tr>
...
src="./images/pixel.gif"></td></tr>
<tr bgcolor="<?=$altbg1?>" class="tablerow">
<td colspan="4"><?=$lang_textnewpicon?>&nbsp;&nbsp;<input type="text" 
name="newurl2" /></td>
</tr>

</table>
</td></tr></table>
<center><input type="submit" name="smiliesubmit" 
value="<?=$lang_textsubmitchanges?>" /></center>
</form>
...
if($smiliesubmit) {
$querysmilie = $db->query("SELECT id FROM $table_smilies WHERE 
type='smiley'");
...
$query = $db->query("UPDATE $table_smilies SET code='$code', url='$url' 
WHERE id='$smilie[id]' AND type='smiley'");
}
...
$query = $db->query("UPDATE $table_smilies SET url='$url' WHERE 
id='$picon[id]' AND type='picon'");
}


if($newcode != "") {
$query = $db->query("INSERT INTO $table_smilies VALUES ('smiley', 
'$newcode', '$newurl1', '')");
}

if($newurl2 != "") {
$query = $db->query("INSERT INTO $table_smilies VALUES ('picon', '', 
'$newurl2', '')");
}

echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_smilieupdate</td></tr>";
}
}
...
<center><input type="submit" name="censorsubmit" 
value="<?=$lang_textsubmitchanges?>" /></center>
</form>
...
$db->query("UPDATE $table_words SET find='$find', replace1='$replace' WHERE 
id='$censor[id]'");
}
...
echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_censorupdate</td></tr>";
}
}
...
<center><input type="submit" name="rankssubmit" 
value="<?=$lang_textsubmitchanges?>" /></center>
</form>
...
<center><input type="submit" name="newslettersubmit" 
value="<?=$lang_textsubmitchanges?>" /></center>
</form>
...
'$xmbuser', '" . time() . "', '$newssubject', '$newsmessage', 'inbox')");
} else {
mail("$memnews[email]", "$newssubject", "$newsmessage", "$lang_textfrom 
$adminemail");
}

}
echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_newslettersubmit </td></tr>";
}
}
...
$querycat = $db->query("SELECT * FROM $table_forums WHERE type='forum' ORDER 
BY displayorder");
...
<center><input type="submit" name="prunesubmit" 
value="<?=$lang_textsubmitchanges?>" /></center>
</form>
...
$querythread = $db->query("SELECT * FROM $table_threads WHERE lastpost <= 
'$prunedate'");
} else {
$querythread = $db->query("SELECT * FROM $table_threads WHERE lastpost <= 
'$prunedate' AND fid='$forumprune'");
}

while($thread = $db->fetch_array($querythread)) {
$db->query("DELETE FROM $table_threads WHERE tid='$thread[tid]'");
$db->query("UPDATE $table_forums SET posts=post-1, threads=threads-1 WHERE 
fid='$thread[fid]'");
$db->query("UPDATE $table_members SET postnum=postnum-1 WHERE 
username='$thread[author]'");

$querypost = $db->query("SELECT * FROM $table_posts WHERE 
tid='$thread[tid]'");
...
echo "<select name=\"tid\"><option 
value=\"default\">$lang_selecttemplate</option>";
...
class=\"subject\">$lang_selecttemplate</td>";
	echo "<script> function redirect() { 
window.location.replace(\"cp2.php?action=templates\"); } 
setTimeout(\"redirect();\", 2250); </script>";
	exit;
}
?>
<tr bgcolor="<?=$altbg2?>">
...
<?
$query = $db->query("SELECT * FROM $table_templates WHERE id='$tid' ORDER BY 
name");
...
if($tid == "new") {
$db->query("INSERT INTO $table_templates VALUES('', '$namenew', 
'$templatenew')");
} else {
$db->query("UPDATE $table_templates SET template='$templatenew' WHERE 
id='$tid'");
}
echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_templatesupdate</td></tr>";
}
if($delete) {
...
cellpadding="<?=$tablespace?>" width="100%">
		...
		$query = $db->query("SELECT a.*, p.*, t.tid, t.subject AS tsubject, f.name 
AS fname FROM $table_attachments a, $table_posts p, $table_threads t, 
$table_forums f WHERE a.pid=p.pid AND t.tid=a.tid AND f.fid=p.fid 
$queryforum $querydate $queryauthor $queryname $querysizeless 
$querysizemore");
		while($attachment = $db->fetch_array($query)) {
			$attachsize = strlen($attachment[attachment]);
			if($attachsize >= 1073741824) { $attachsize = round($attachsize / 
1073741824 * 100) / 100 . "gb"; }
			elseif($attachsize >= 1048576) { $attachsize = round($attachsize / 
1048576 * 100) / 100 . "mb"; }
			elseif($attachsize >= 1024)	{ $attachsize = round($attachsize / 1024 * 
100) / 100 . "kb"; }
			...
			<tr>
			<td bgcolor="<?=$altbg1?>" class="tablerow" align="center" 
valign="top"><input type="checkbox" name="delete<?=$attachment[aid]?>" 
value="<?=$attachment[aid]?>"></td>
			<td bgcolor="<?=$altbg2?>" class="tablerow" valign="top"><input 
type="text" name="filename<?=$attachment[aid]?>" 
value="<?=$attachment[filename]?>"><br><small><a 
href="viewthread.php?action=attachment&tid=<?=$attachment[tid]?>&pid=<?=$attachment[pid]?>"><?=$lang_textdownload?></a></td>
			<td bgcolor="<?=$altbg2?>" class="tablerow" 
valign="top"><?=$attachment[author]?></td>
			<td bgcolor="<?=$altbg2?>" class="tablerow" valign="top"><a 
href="viewthread.php?tid=<?=$attachment[tid]?>"><?=$attachment[tsubject]?></a><br><small><?=$lang_textinforum?> 
<a 
href="forumdisplay.php?fid=<?=$attachment[fid]?>"><?=$attachment[fname]?></a></small></td>
			<td bgcolor="<?=$altbg2?>" class="tablerow" valign="top" 
align="center"><?=$attachsize?></td>
			<td bgcolor="<?=$altbg2?>" class="tablerow" valign="top" 
align="center"><?=$attachment[downloads]?></td>
			</tr>
			<?
...
$querysizemore");
		while($attachment = $db->fetch_array($query)) {
			...
			$delete = "${$delete}";
			$afilename = "afilename$attachment[aid]";
			$afilename = "${$afilename}";
			...
			if($delete != "") {
				$db->query("DELETE FROM $table_attachments WHERE 
aid='$attachment[aid]'");
			}
			if($attachment[filename] != $afilename) {
				$db->query("UPDATE $table_attachments SET filename='$afilename' WHERE 
aid='$attachment[aid]'");
			}
		}
		echo "<tr bgcolor=\"$altbg2\" class=\"tablerow\"><td 
align=\"center\">$lang_textattachmentsupdate</td></tr>";
	}
}
