		...
		<td bgcolor="<?=$bordercolor?>">
			<table border="0" cellspacing="<?=$borderwidth?>" cellpadding="<?=$tablespace?>" width="100%">
				...
				<tr bgcolor="<?=$altbg1?>" class="tablerow">
					<td align="center">
						<a href="cp.php?action=settings"><?=$lang_textsettings?></a> - <a href="cp.php?action=forum"><?=$lang_textforums?></a> - <a href="cp.php?action=mods"><?=$lang_textmods?></a> - <a href="cp.php?action=members"><?=$lang_textmembers?></a> - <a href="cp.php?action=ipban"><?=$lang_textipban?></a> - <a href="cp.php?action=upgrade"><?=$lang_textupgrade?></a> - <a href="cp2.php?action=cplog">CP Log</a> <br /> 
						<a href="cp2.php?action=themes"><?=$lang_themes?></a> - <a href="cp2.php?action=smilies"><?=$lang_smilies?></a> - <a href="cp2.php?action=censor"><?=$lang_textcensors?></a> - <a href="cp2.php?action=ranks"><?=$lang_textuserranks?></a> - <a href="cp2.php?action=newsletter"><?=$lang_textnewsletter?></a> - <a href="cp2.php?action=prune"><?=$lang_textprune?></a> - <a href="cp2.php?action=templates"><?=$lang_templates?></a> - <a href="cp2.php?action=attachments"><?=$lang_textattachman?></a><br />
...
?>
							...
							<center><input type="submit" name="themesubmit" value="<?=$lang_textsubmitchanges?>" /></center></form><br>
						...
						<table cellspacing="0" cellpadding="0" border="0" width="500" align="center">
							...
							<center><input type="submit" name="importsubmit" value="<?=$lang_textimportsubmit?>" /></center></form>
					</td>
				</tr>
	...
	<tr bgcolor="<?=$altbg2?>">
		...
		<br /><form method="post" action="cp2.php?action=themes&single=submit">
			<table cellspacing="0" cellpadding="0" border="0" width="93%" align="center">
				...
				<center><input type="submit" value="<?=$lang_textsubmitchanges?>" /></center><input type="hidden" name="orig" value="<?=$single?>" /></form>
		</td>
	</tr>
...
?>
	...
	<tr bgcolor="<?=$altbg2?>">
		...
		<table cellspacing="0" cellpadding="0" border="0" width="93%" align="center">
			...
			<center><input type="submit" value="<?=$lang_textsubmitchanges?>" /></center><input type="hidden" name="newtheme" value="<?=$single?>" /></form>
		</td>
	</tr>
...
?>
				...
				<center><input type="submit" name="smiliesubmit" value="<?=$lang_textsubmitchanges?>" /></center></form>
		</td>
	</tr>
...
$db->query("INSERT INTO $table_u2u VALUES('', '$memnews[username]', '$xmbuser', '" . time() . "', '$newssubject', '$newsmessage', 'inbox', 'yes')"); 
} else {
mail("$memnews[email]", "$newssubject", "$newsmessage", "From: $adminemail");
}
