...
$lang['admin_found_install'] = "The installation files (\"./install/\") have been found on the server, but could not be removed automatically. Please remove them as soon as possible.";
$lang['admin_found_updir'] = "The upgrade tool (\"./upgrade/\") has been found on the server, but could not be removed automatically. Please remove it as soon as possible.";
$lang['admin_found_upfile'] = "The upgrade tool (\"./upgrade.php\") has been found on the server. Please remove it as soon as possible.";
...
$lang['admin_rename_fail'] = "Could not rename user. Either the user does not exist, or the new username is already in use.";
...
$lang['altmsnyes'] = "This user has MSN Messenger"; // remove me
...
$lang['beenfound'] = "accounts have been found.";
$lang['beenfound_singular'] = 'account has been found.';
...
$lang['byte'] = "byte(s)";
$lang['cannotmergesamethread'] = 'I am sorry, but it is impossible to merge a thread with itself.'; // I'm keeping this one as-is just because it made me giggle
...
$lang['config_error_file'] = "The config.php file was not found or cannot be accessed.";
$lang['config_form_db'] = "Database Connection Settings";
$lang['config_form_db_host'] = "Database Host";
$lang['config_form_db_host_def'] = "Database host location, usually &quot;localhost&quot;.";
...
$lang['config_form_db_type_def'] = "The type of database connection.";
...
$lang['config_form_email_detail'] = "XMB by default uses PHP's mail() functionality to send email from the board. As some hosts don't allow direct use of this function, you may chose to configure XMB to use SMTP to send email instead. Please choose your configuration below.";
$lang['config_form_email_handler'] = "Mail Handler";
$lang['config_form_email_handler_def'] = "Chose your mail handler. If you wish to use PHP's inbuilt mailer functionality, select &quot;Default&quot; and disregard the configuration options below. If you chose SMTP, please complete the options below. Default: &quot;Default&quot;.";
...
$lang['coppa_explained'] = "This information is a required part of our registration process. We will not share your answer with any third parties.";
...
$lang['delete_all_themes'] = "You can not delete your last theme! Your board won't work without it!"; // LOL keeping this one as well
...
$lang['emailpw'] = "Your password reset request has been received. Please check the email address associated with your account.<br />If the email does not arrive, contact an administrator outside the board.";
...
$lang['ipreg'] = "Only allow one registration per IP every 24 hours?";
...
$lang['login_lockout'] = "Your account is temporarily locked due to an unusually high volume of bad login attempts.";
...
$lang['nomoodtext'] = "No Mood"; // connected to deleted code
...
$lang['reportmsg'] = "Thank you for submitting a post report. You are now being forwarded back to the thread page.";
...
$lang['templaterestoreconfirm'] = "Are you sure you want to restore the templates to their default state in <strong>templates.xmb</strong>? <strong>templates.xmb</strong> must be in your forums directory for this to work!"; // Update needed
$lang['templates'] = "Templates";
$lang['templatesdelete'] = "Template deleted successfully";
$lang['templatesrestoredone'] = "All templates have been restored to the ones in templates.xmb"; // Needs updating because of new system
...
$lang['textfaq'] = "FAQ"; // https://www.youtube.com/watch?v=O_2HnzozHRA
...
$lang['textfaqans1'] = "To register and join our community, <a href='member.php?action=reg'>click here</a>.<br /><br />You may be required to activate your account before being able to login for the first time.";
$lang['textfaqans10'] = "You can view all the members by clicking on the <a href=\"misc.php?action=list\">Member List</a> button in the menu. You can also sort them by various criteria.";
$lang['textfaqans11'] = "When inside a forum, clicking on 'Post New Topic' (or the image that represents that) will allow you to post a new topic. You will need to fill in a subject title and a message, then click on the 'Post New Topic' button.";
$lang['textfaqans12'] = "Yes, this is done the same as posting a new one, except that you must be in an existing topic, and you need to click 'Post Reply' instead of 'Post new Topic'. You can also click 'Quote' to include an existing post as part of your reply and respond in a more direct way to somebody/a specific part of the discussion.";
...
$lang['textfaqans14'] = "You can edit a post by clicking on the 'Edit Post' button above your message. You can only edit your own posts, and depending on the forum, this feature is disabled.";
$lang['textfaqans15'] = "Depending on the forum settings, you can insert an attachment with your posts. If you see an upload form on the New Post or New Reply pages, it's allowed. Make sure to check your attachment does not exceed the file limits.<br>Images uploaded to posts will also embed themselves into posts with a preview.";
$lang['textfaqans16'] = "Smilies are the little faces and icons to the right of the input for message, and can be entered by clicking on them. They display graphical faces instead of simply a <strong>:)</strong> or typical Unicode emoji.<br />Here is a list of current supported smilies for convenience:";
$lang['textfaqans17'] = "You can create a poll by visiting the forum you want to post the poll in, and click on 'Post New Poll' (if the option is available). The screen following after you click the button is just like a normal new thread page, but has an extra box for poll answers. You should enter one answer per line.<br /><br />You can vote on polls in threads by visiting the thread with the poll in it, and selecting the option you want to vote for, and then clicking the submit button. You can only vote on a poll once, so once you vote, you can't change your mind!";
$lang['textfaqans19'] = "Staff positions are reserved for those trusted by the administrators of the forum. By regularly posting and contributing, and becoming a well-respected member over a long period of time, there's a chance - depending on the circumstances and whether the admins feel there's a need for more staff - that you'll be lucky enough to get picked out. In which case, do feel honoured, but do stay humble, please.";
$lang['textfaqans2'] = "Yes. This board (by default) uses cookies to store your login information.<br /><br />If you logout, your cookies will be cleared. To logout <a href=\"misc.php?action=logout\">click here</a>."; // This needs checking. I know some stuff was changed in 1.9.12, so the old text was outdated, but idk what exactly.
$lang['textfaqans21'] = "You can logout by clicking Logout at the top of the page."; // again, compare the diff please, due to the Device Stuff
$lang['textfaqans3'] = "To add a signature to your posts, go to your <a href=\"memcp.php\">member profile</a>, click 'edit', scroll down a bit, and insert into the 'Signature' text box the signature you wish to use.";
$lang['textfaqans4'] = "Again in your <a href=\"memcp.php\">profile</a> there is a place for an 'Avatar' - an avatar is the image under your username, displayed in your posts. It's usually common courtesy to use an image under or equal to 100x100 pixels.<br /><br />You'll also need to upload the image to somewhere where you can copy the direct URL, and paste it into the box.";
$lang['textfaqans5'] = "If you have forgotten your password, do not worry! Head over to the <a href=\"misc.php?action=lostpw\">lost password section</a> and fill in the form and your password will be e-mailed to you. If this is unfeasible for you for some reason, please contact an administrator outside the board.";
...
$lang['textfaqans8'] = "By clicking on the 'Search' button in the menu and inputting what you wish to search for. You can further restrict what you want to search for with the given selections.";
...
$lang['textfixmoods'] = "Reset Blank Moods"; // NUKE
...
$lang['texthtml'] = "HTML"; // Unused in 1.10.x 
$lang['texthtmlis'] = "HTML is"; // Unused in 1.10.x
$lang['texticon'] = "Icon:";
$lang['texticq'] = "ICQ:";
...
$lang['textinvisible'] = "Invisible Mode";
$lang['textip'] = "IP";
...
$lang['textyahoo'] = "Yahoo:"; // REMOVE ME
$lang['textyes'] = "Yes";
...
$lang['translation_name'] = "Translation Name"; // still needed??
...
$lang['upgrade_intro'] = "This procedure can upgrade the database from XMB versions 1.8 and greater, including \$ver Betas."; // can it tho?
...
$lang['welcomeunreg'] = "If you are not registered or logged in, you may still be able to view forums and topics, but you will not be able to fully interact with the forum, have access to your user control panel or customize your site browsing settings.";
