...
$lang['textfaqans1'] = "To register and join our community, <a href='member.php?action=reg'>click here</a>.<br /><br />You may be required to receive a password by email before being able to login for the first time.";
...
$lang['textfaqans2'] = "Yes. This board uses cookies to store your login information.<br /><br />If you logout, your cookies will be cleared. To logout <a href='misc.php?action=logout'>click here</a>.";
$lang['textfaqans21'] = "You can logout by clicking Logout at the top of the page.";
$lang['textfaqans3'] = "To add a signature to your posts, go to your <a href='memcp.php'>control panel</a>, click 'Edit Profile', scroll down a bit, and insert into the 'Signature' text box the signature you wish to use.";
$lang['textfaqans4'] = "In your <a href='memcp.php'>control panel</a> there is a place for an 'Avatar'. An avatar is the image under your username, displayed in your posts. It's advisable to use an image under or equal to 100x100 pixels.<br /><br />You'll also need a published URL for the avatar, so that you can paste it into the box.";
