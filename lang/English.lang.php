...
$lang['admin_main_settings9'] = "Index Page Options";
...
$lang['admin_rename_warn_self'] = "Warning: You have changed your own username, and thus will now be logged out. To log back in, please use your new username.";
...
$lang['altvisitsite'] = "Visit user's website";
...
$lang['byte'] = "byte(s)";
$lang['cannotmergesamethread'] = 'It is impossible to merge a thread with itself.'
...
$lang['config_form_db_host_def'] = "Database host location, usually &quot;localhost&quot;. If you are using a shared web hosting plan, please check your control panel or ask the person responsible for hosting your site.";
...
$lang['config_form_email_detail'] = "XMB by default uses PHP's mail() functionality to send email from the board. As some hosts don't allow full access to this function (or otherwise there are issues with message delivery), you may chose to configure XMB to use SMTP to send email instead. Please choose your configuration below.";
...
$lang['evalstats1'] = "<strong>General Counters:</strong>";
...
$lang['floodprotect'] = "You are posting too fast! Try again in a few moments.";
$lang['floodprotect_u2u'] = "You are sending messages too fast! Try again in a few moments.";
...
$lang['lostpw_body_eval'] = "Hello \$name,\n\nA password reset request was received for your lost login details on \$bbname.  To set a new password, you must follow the link below.\n\n\$link\n\nThis link will expire after one use, or 24 hours, whichever is first.";
...
$lang['max_addresses_per_entry'] = "Due to server protection, it is not allowed to save more than ten addresses at one time.";
...
$lang['textfaqans2'] = "Yes. This board (by default) uses cookies to store your login information.<br /><br />If you logout, your cookies will be cleared. To logout <a href=\"misc.php?action=logout\">click here</a>.";
...
$lang['textsite'] = "Website:"; // For the sakes of clarity, this pertains to the memcp/profile page field.
...
$lang['welcomeunreg'] = "If you are not registered or logged in, you may still be able to view forums and topics, but you will not be able to fully interact with the forum, have access to your user control panel or customize your browsing experience.";
