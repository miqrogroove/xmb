...
$lang_replymsg = "Thank you, your post has been submitted. You are now being forwarded to the thread page";
$lang_regged = "Thank you for registering";
$lang_textnever = "Never";
$lang_textregister = "Register";
$lang_textmemberlist = "Member List";
$lang_textregistered = "Registered:";
$lang_textpwincorrect = "Password incorrect";
...
$lang_textbio = "Bio:";
$lang_textcp = "Control Panel";
$lang_notadmin = "Sorry, you are not an admin";
...
$lang_multmodnote = "Note: To make multiple moderators, separate moderators with a comma (ex: webfr34k, Testman, someothermod)";
...
$lang_stats4 = "Newest member is";
$lang_texttpp = "Topics Per Page:";
$lang_textboardlogo = "Board Logo URL:";
...
$lang_texttop = "Top Table Color:";
$lang_textcatcolor = "Category Color:";
...
[email]nh@xmbforum.com[/email] &nbsp; (E-Mail Link)<br /><br />
[email=nh@xmbforum.com]E-mail Me![/email] &nbsp; (E-Mail Link)<br /><br />
...
$lang_whosoneval = '$lang_whosonmsg = "$onlinenum users online ($guestcount guest(s) and $membercount member(s)).";';
...
$lang_imsentmsg = "Your U2U message has been sent. You will now be taken back to your instant message list";
...
$lang_textpostnum = "Number of Posts";
...
$lang_textlostpw = "Lost Password";
$lang_textsubmit = "Submit";
$lang_badinfo = "Wrong username and email.";
$lang_textyourpw = "Your password";
$lang_textyourpwis = "Your username and password are:";
$lang_emailpw = "Your password has been emailed to you.";
...
$lang_upgrade = "Insert the mysql from upgrade.txt below to upgrade.";
...
$lang_whocanpost12 = "Administrators can post new topics";
$lang_whocanpost13 = "Administrators and Moderators can post new topics";
...
$lang_ignoremsg = "Ignore List:<br /><small>Separate names with commas (i.e. \"webfr34k, bondman, Ace,\"). Make sure you leave a comma after the last name.</small>";
...
$lang_textsubsubject = "New Reply To:";
$lang_textsubbody = " has suggest replied to a thread you have subscribed to at $bbname.\n\nYou can visit the thread by going to\n\n";
...
you register so you can recieve emails from the administrator.";
...
$lang_evalusercpwelcome = '$lang_usercpwelcome = "Hello $thisuser, welcome
...
$lang_textusercp = "User Control Panel";
...
$lang_textlatestu2us = "Latest Five U2U Messages";
...
$lang_textbriefsummary = "Brief Account Summary:";
...
$lang_textsubaol = "\n\nAOL users may click the link below\n\n";
