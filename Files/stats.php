<?php
/* $Id: stats.php,v 1.13.2.11 2005/01/15 23:41:47 Daf Exp $ */
/*
    XMB 1.9
...
// Pre-load templates (saves queries)
    loadtemplates('error', 'footer_load', 'footer_querynum', 'footer_phpsql', 'footer_totaltime','header','feature_statistics','footer', 'css');
    smcwcache();
