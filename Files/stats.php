<?php
/* $Id: stats.php,v 1.3.2.3 2005/09/16 09:38:53 Tularis Exp $ */
/*
    XMB 1.9.2
...
// Get most popular forum
    $query      = $db->query("SELECT f.posts, f.threads, f.fid, f.name FROM $table_forums f $restrict f.fid = f.fid AND f.type='sub' OR f.type='forum' ORDER BY posts DESC LIMIT 0, 1");
