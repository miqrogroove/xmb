<?php
/* $Id: post.php,v 1.3.2.11 2005/09/16 09:38:53 Tularis Exp $ */
/*
    XMB 1.9.2
...
if(isset($topicsubmit)) {
	...
	if(!isset($subject) || trim($subject) == '') {
		$preview = error($lang['textnosubject'], false, '', '', false, false, true, false);
		$error = true;
		unset($topicsubmit);
