<?php
/* $Id: cp2.php,v 1.3.2.22 2006/09/22 09:11:12 Tularis Exp $ */
/*
    XMB 1.9.2
...
elseif ($action == "smilies") {
    if (!isset($smiliesubmit)) {
        ...
        while ($smilie = $db->fetch_array($query)) {
            ...
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><img src="<?php echo $smdir?>/<?php echo $smilie['url']?>" alt="<?php echo $smilie['code']?>" /></td>
            </tr>
            <?php
        }
        ...
        $query = $db->query("SELECT * FROM $table_smilies WHERE type='picon' ORDER BY id");
            ...
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><img src="<?php echo $smdir?>/<?php echo $smilie['url']?>" alt="<?php echo $smilie['url']?>" /></td>
            </tr>
