<?php
/* $Id: cp2.php,v 1.28.2.24 2004/09/24 19:21:05 Tularis Exp $ */
/*
    XMB 1.9
...
if (X_ADMIN) {
    ...
    elseif ($action == 'dbdump') {
        $time = time();
        header("Content-disposition: attachment; filename=$bbname-$time.sql");
        ...
        echo "-- --------------------------------------\n";
        echo "-- XMB 1.9.1 RC3 Database Dump function\n";
        echo "-- Created by: Tularis\n";
        echo "-- Version 1.00\n";
        echo "-- Copyright (c) 2001-2004 \n";
...
elseif ($action == "themes") {
    if (!isset($themesubmit) && !isset($single) && !isset($importsubmit)) {
        ...
        <tr>
        <td bgcolor="<?php echo $altbg2?>" class="tablerow" align="center" colspan="2"><input type="submit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /><input type="hidden" name="orig" value="<?php echo $single?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
...
if (isset($censorsubmit)) {
    ...
    if (!isset($rankssubmit)) {
        ...
        <tr class="category">
        <td align="center"><strong><font color="<?php echo $cattext?>"><?php echo $lang['textdeleteques']?></font></strong></td>
        <td align="left"><strong><font color="<?php echo $cattext?>"><?php echo $lang['textcusstatus']?></font></strong></td>
        <td><strong><font color="<?php echo $cattext?>"><?php echo $lang['textposts']?></font></strong></td>
        <td><strong><font color="<?php echo $cattext?>"><?php echo $lang['textstars']?></font></strong></td>
        <td><strong><font color="<?php echo $cattext?>"><?php echo $lang['textallowavatars']?></font></strong></td>
        <td><strong><font color="<?php echo $cattext?>"><?php echo $lang['textavatar']?></font></strong></td>
        </tr>
        ...
        while ($rank = $db->fetch_array($query)) {
            ...
            <tr bgcolor="<?php echo $altbg2?>" class="tablerow">
            <td align="center"><input type="checkbox" name="delete[<?php echo $rank['id']?>]" value="1" <?php echo $staff_disable?> /></td>
            <td align="left"><input type="text" name="title[<?php echo $rank['id']?>]" value="<?php echo $rank['title']?>" <?php echo $staff_disable?>/></td>
            ...
            <td><input type="text" name="avaurl[<?php echo $rank['id']?>]" value="<?php echo $rank['avatarrank']?>" size="20" /></td>
            </tr>
        ...
        <td><select name="newallowavatars"><option value="yes"><?php echo $lang['texton']?></option>
            ...
            <tr>
                <td bgcolor="<?php echo $bordercolor?>">
                    <table border="0" cellspacing="<?php echo $borderwidth?>" cellpadding="<?php echo $tablespace?>" width="100%" style="vertical-align: top;">
                        ...
                        <tr>
                            <td class="tablerow" style="background-color: <?php echo $altbg1?>;" colspan="2">
                                <input type="submit" name="pruneSubmit" value="<?php echo $lang['textprune']?>" />
                            </td>
                        </tr>
                    </table>
                </td>
...
elseif ($action == "modlog") {
    ...
    <?php
    $count = $db->result($db->query("SELECT count(*) FROM $table_logs WHERE NOT (fid='0' AND tid='0')"), 0);
...
elseif ($action == "cplog") {
    ...
    <?php
    $count = $db->result($db->query("SELECT count(*) FROM $table_logs WHERE (fid='0' AND tid='0')"), 0);
