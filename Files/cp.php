<?php
/* $Id: cp.php,v 1.3.2.34 2006/09/25 09:38:01 Tularis Exp $ */
/*
    XMB 1.9.2
...
function printsetting1($setname, $varname, $check1, $check2) {
    global $lang, $THEME;
    ?>
    <tr><td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $setname?></td>
    <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><select name="<?php echo $varname?>">
...
function printsetting2($setname, $varname, $value, $size) {
    ...
    ?>
    <tr>
    <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $setname?></td>
    <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="text"  size="<?php echo $size?>" value="<?php echo $value?>" name="<?php echo $varname?>" /></td>
    </tr>
    <?php
}
...
function printsetting3($setname, $boxname, $varnames, $values, $checked, $multi=true) {
    ...
    <tr>
    <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $setname?></td>
    <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><select <?php echo ($multi ? 'multiple="multiple"' : '')?> name="<?php echo $boxname?><?php echo ($multi ? '[]' : '')?>"><?php echo $optionlist?></select></td>
    </tr>
    <?php
}
...
function printsetting4($settingDesc, $name, $value, $rows=5, $cols=50) {
    ...
    ?>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $settingDesc?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><textarea rows="<?php echo $rows; ?>" name="<?php echo $name; ?>" cols="<?php echo $cols; ?>"><?php echo $value?></textarea></td>
        </tr>
    <?php
}
...
if ($action == "settings") {
    if (!isset($_POST['settingsubmit'])) {
        ...
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="2">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textlanguage']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><?php echo $langfileselect?></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['texttheme']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><?php echo $themelist?></td>
        </tr>
        ...
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['texttimeformat']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="radio" value="24" name="timeformatnew" <?php echo $check24?> />&nbsp;<?php echo $lang['text24hour']?>&nbsp;<input type="radio" value="12" name="timeformatnew" <?php echo $check12?> />&nbsp;<?php echo $lang['text12hour']?></td>
        </tr>
        ...
        <tr>
        <td align="center" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="2"><input class="submit" type="submit" name="settingsubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['textsettingsupdate'].'</td></tr>';
    }
}
...
if ($action == "rename") {
    ...
    if (isset($_POST['renamesubmit']) && isset($frmUserFrom) && isset($frmUserTo)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$myErr.'</td></tr>';
    } else {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" width="22%"><?php echo $lang['admin_rename_userfrom']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="frmUserFrom" size="25" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" width="22%"><?php echo $lang['admin_rename_userto']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="frmUserTo" size="25" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" colspan="2" align="center"><input type="submit" class="submit" name="renamesubmit" value="<?php echo $lang['admin_rename_txt']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
...
if ($action == "forum") {
    if (!isset($_POST['forumsubmit']) && !isset($fdetails)) {
        ...
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="smalltxt"><input type="text" name="newfname" value="<?php echo $lang['textnewforum']?>" />
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center"><input type="submit" name="forumsubmit" value="<?php echo $lang['textsubmitchanges']?>" class="submit" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textforumname']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="namenew" value="<?php echo htmlspecialchars($forum['name'])?>" /></td>
        </tr>
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textdesc']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><textarea rows="4" cols="30" name="descnew"><?php echo htmlspecialchars($forum['description'])?></textarea></td>
        </tr>
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>" valign="top"><?php echo $lang['textallow']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="smalltxt"><input type="checkbox" name="allowhtmlnew" value="yes" <?php echo $checked2?> /><?php echo $lang['texthtml']?><br />
        ...
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['texttheme']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><?php echo $themelist?></td>
        </tr>
        
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['forumpermissions']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><table style="width: 100%;">
        <?php
        ...
        foreach($statusList as $key=>$val) {
            ...
            <tr class="tablerow">
                ...
                <td class="altbg1 ctrtablerow"><input type="checkbox" name="permsNew[0][]" value="<?php echo $val;?>" <?php echo ((($perms[X_PERMS_POLL]&$val) == $val) ? 'checked="checked"' : ''); ?> /></td>
                <td class="altbg1 ctrtablerow"><input type="checkbox" name="permsNew[1][]" value="<?php echo $val;?>" <?php echo ((($perms[X_PERMS_THREAD]&$val) == $val) ? 'checked="checked"' : ''); ?> /></td>
                <td class="altbg1 ctrtablerow"><input type="checkbox" name="permsNew[2][]" value="<?php echo $val;?>" <?php echo ((($perms[X_PERMS_REPLY]&$val) == $val) ? 'checked="checked"' : ''); ?> /></td>
                <td class="altbg1 ctrtablerow"><input type="checkbox" name="permsNew[3][]" value="<?php echo $val;?>" <?php echo ((($perms[X_PERMS_VIEW]&$val) == $val) ? 'checked="checked"' : ''); ?> /></td>
            </tr>
            <?php
        }
        ?>
        ...
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textuserlist']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><textarea rows="4" cols="30" name="userlistnew"><?php echo $forum['userlist']?></textarea></td>
        </tr>
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['forumpw']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="passwordnew" value="<?php echo htmlspecialchars($forum['password'])?>" /></td>
        </tr>
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textdeleteques']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="checkbox" name="delete" value="<?php echo $forum['fid']?>" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="2"><input type="submit" name="forumsubmit" value="<?php echo $lang['textsubmitchanges']?>" class="submit" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        if (!isset($fdetails)) {
            ...
            echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['textforumupdate'].'</td></tr>';
        } else {
...
if ($action == "mods") {
    if (!isset($_POST['modsubmit'])) {
        ...
        ?>
        <tr>
        <td colspan="2" class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><span class="smalltxt"><?php echo $lang['multmodnote']?></span></td>
        </tr>
        <tr>
        <td align="center" colspan="2" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="submit" class="submit" name="modsubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['textmodupdate'].'</td></tr>';
    }
}
...
if ( $action == "members") {
    if (!isset($_POST['membersubmit'])) {
        if (!isset($members)) {
            ...
            <tr>
            <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>" width="22%"><?php echo $lang['textsrchusr']; ?></td>
            <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="srchmem" /></td>
            </tr>
            <tr>
            <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>" width="22%"><?php echo $lang['textwithstatus']?></td>
            ...
            <tr>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="2"><input type="submit" class="submit" value="<?php echo $lang['textgo']?>" /></td>
            </tr>
            </table>
            </td>
            </tr>
            ...
            while ($member = $db->fetch_array($query)) {
                ...
                <br /><a href="u2uadmin.php?uid=<?php echo rawurlencode($member['username'])?>"><?php echo $lang['cp_viewinbox']?></a></td>
            ...
            <tr>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="7"><input type="submit" class="submit" name="membersubmit" value="<?php echo $lang['textsubmitchanges']?>" /><input type="hidden" name="srchmem" value="<?php echo $srchmem?>" /><input type="hidden" name="srchstatus" value="<?php echo $srchstatus?>" /></td>
            </tr>
            </table>
            </td>
            </tr>
        ...
        */
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['textmembersupdate'].'</td></tr>';
    }
}
...
if ($action == "ipban") {
    if (!isset($_POST['ipbansubmit'])) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'"><td align="center">';
        ...
        while ($ipadr = $db->fetch_array($query)) {
            ...
            echo '<tr style="background-color: '.$THEME['altbg1'].'"><td class="tablerow" align="center"><input type="checkbox" name="delete['.$ipadr['id'].']" value="1" /></td>';
        ...
        echo '<tr><td style="background-color: '.$THEME['altbg2'].'"><input type="text" name="newip1" size="3" maxlength="3" onKeyUp="return autotab(this, document.ipban.newip2);" style="background-color: '.$THEME['altbg2'].'" />.<input type="text" name="newip2" size="3" maxlength="3" onKeyUp="return autotab(this, document.ipban.newip3);" style="background-color: '.$THEME['altbg2'].'" />.<input type="text" name="newip3" size="3" maxlength="3" onKeyUp="return autotab(this, document.ipban.newip4);" style="background-color: '.$THEME['altbg2'].'" />.<input type="text" name="newip4" size="3" maxlength="3" style="background-color: '.$THEME['altbg2'].'" /></td>';
        echo '<td style="background-color: '.$THEME['altbg2'].'" colspan="3"><font class="smalltxt">'.$lang['multipnote'].'</font></td></tr>';
        echo '<tr><td style="background-color: '.$THEME['altbg2'].'" colspan="4" align="center"><font class="smalltxt">'.$lang['currentip'].'&nbsp;<strong>'.$onlineip.'</strong>'.$warning.'</font></td>';
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'"><td align="center" class="tablerow">'.$self['status'].'</td></tr>';
    }
}
...
if ($action == "upgrade") {
    ...
    if (isset($_POST['upgradesubmit'])) {
        ...
        <table border="0" cellspacing="<?php echo $THEME['borderwidth']?>" cellpadding="<?php echo $THEME['tablespace']?>" width="100%">
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>" colspan="2"><strong><?php echo $lang['textupgrade']?></strong></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" colspan="2"><?php echo $lang['upgrade']?></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" valign="top"><textarea cols="85" rows="10" name="upgrade"></textarea></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" colspan="2"><input type="file" name="sql_file" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" colspan="2"><?php echo $lang['upgradenote']?></td>
        </tr>
        <tr>
        <td class="ctrtablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="2"><input type="submit" class="submit" name="upgradesubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
...
if ($action == "search") {
    if (isset($_POST['searchsubmit'])) {
        ...
        foreach ($list as $num=>$val) {
            ...
            <td align="left" style="background-color: <?php echo $THEME['altbg2']?>">
            <strong><?php echo ($num+1)?>.</strong>
            </td>
            <td align="left" width="95%" style="background-color: <?php echo $THEME['altbg1']?>">
            <?php echo $val?>
            </td>
            </tr>
