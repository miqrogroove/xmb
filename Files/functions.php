<?php
/* $Id: functions.php,v 1.3.2.15 2005/09/17 08:25:11 Tularis Exp $ */
/*
    XMB 1.9.2
...
function loadtemplates() {
    ...
    if ( $num < 1) {
        ...
        $namesarray = array_unique(array_merge(func_get_args(), array('header', 'css', 'error', 'footer')));
...
*/
function altMail($to, $subject, $message, $additional_headers='', $additional_parameters='') {
	global $mailer;
	...
	switch($mailer['type']) {
		case 'socket_SMTP':
			...
			return $mail->sendMessage($from, $to, $subject, $additional_headers);
			break;
