<?php
/* $Id: misc.php,v 1.3.2.10 2005/09/20 08:42:44 Tularis Exp $ */
/*
    XMB 1.9.2
...
// pre-Load templates (saves queries)
    loadtemplates('footer_load', 'footer_phpsql', 'footer_querynum', 'footer_totaltime', 'functions_smilieinsert', 'functions_smilieinsert_smilie', 'misc_feature_not_while_loggedin', 'misc_feature_notavailable', 'misc_feature_notavailable', 'misc_login', 'misc_lostpw', 'misc_mlist', 'misc_mlist_admin', 'misc_mlist_multipage', 'misc_mlist_results_none', 'misc_mlist_row', 'misc_mlist_row_email', 'misc_mlist_row_site', 'misc_mlist_separator', 'misc_online', 'misc_online_admin', 'misc_online_row', 'misc_online_row_admin', 'misc_online_today', 'misc_online_u2ufield', 'misc_search', 'misc_search_nextlink', 'misc_search_results', 'misc_search_results_none', 'misc_search_results_row', 'misc_smilies', 'popup_footer', 'popup_header');
