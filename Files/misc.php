<?php
/* $Id: misc.php,v 1.32.2.23 2004/09/24 19:10:32 Tularis Exp $ */
/*
    XMB 1.9
...
// pre-Load templates (saves queries)
    loadtemplates('footer_load', 'footer_querynum', 'footer_phpsql', 'footer_totaltime','misc_login','misc_search','misc_search_results_row','misc_search_results_none','misc_search_results','misc_lostpw','misc_online_row_admin','misc_online_row','misc_online_admin','misc_online','misc_mlist_row_email','misc_mlist_row_site','misc_mlist_row','misc_mlist','header','footer','css', 'misc_online_u2ufield', 'misc_mlist_admin','misc_online_today', 'misc_lostpw', 'misc_search_nextlink', 'misc_mlist_multipage', 'misc_mlist_seperator', 'misc_mlist_results_none');
    smcwcache();
...
// Based on the action, choose what to do
    ...
    switch ($action) {
        ...
        case 'logout':
            ...
            if ( !isset($xmbuser) || $xmbuser == '' || $onlineuser == "xguest123" ) {
                redirect("index.php", 0);
                break;
            }
        ...
        case 'online':
            ...
            while ($online = $db->fetch_array($query)) {
                ...
                if ($self['status'] == 'Super Administrator' && $online['username'] != 'xguest123' && $online['username'] != $lang['textguest1']) {
                ...
                while ($member = $db->fetch_array($querymem)) {
                    ...
                    if ($order == 'status') {
                        if ($oldst != $member['status']) {
                            ...
                            eval("\$members .= \"".template('misc_mlist_seperator')."\";");
                        }
                    }
