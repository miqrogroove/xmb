<?php
/* $Id: memcp.php,v 1.3.2.23 2006/10/10 23:10:26 Tularis Exp $ */
/*
    XMB 1.9.2
...
function makenav($current) {
    ...
    echo '<td style="background-color: '.$THEME['altbg2'].'" width="20%" class="ctrtablerow"><a href="#" onclick="Popup(\'u2u.php\', \'Window\', 700, 450);>'.$lang['textu2umessenger']. '</a></td>';
    echo '<td style="background-color: '.$THEME['altbg2'].'" width="15%" class="ctrtablerow"><a href="#" onclick="Popup(\'buddy.php?\', \'Window\', 450, 400);">'.$lang['textbuddylist'].'</a></td>';
