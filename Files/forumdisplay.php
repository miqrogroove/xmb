<?php
/* $Id: forumdisplay.php,v 1.3.2.6 2005/09/16 09:38:53 Tularis Exp $ */
/*
    XMB 1.9.2
...
switch($t_extension) {
    ...
    case 'jpeg':
    case 'png':
        $lang['toppedprefix'] = '<img src="'.$imgdir.'/'.$lang['toppedprefix'].'" title="'.$lang['toppedpost'].'" alt="[T]" />';
        break;
}
...
while($thread = $db->fetch_array($querytop)) {
    ...
    $thread['subject'] = checkOutput(censor($thread['subject']));
