<?php
/* $Id: member.php,v 1.3.2.10 2005/09/18 18:20:42 Tularis Exp $ */
/*
    XMB 1.9.2
...
loadtemplates('footer_load', 'footer_querynum', 'footer_phpsql', 'footer_totaltime','member_coppa','member_reg_rules','member_reg_password','member_reg_avatarurl','member_reg_avatarlist','member_reg','member_profile_email','member_profile');
smcwcache();
