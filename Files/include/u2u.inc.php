<?php
/**
* $Id: u2u.inc.php,v 1.9.2.10 2004/09/24 19:09:33 Tularis Exp $
*/
...
function db_u2u_insert( $to, $from, $type, $owner, $folder, $subject, $message, $isRead, $isSent ) {
    ...
    $db->query( "INSERT INTO $table_u2u
                 ( u2uid, msgto, msgfrom, type, owner, folder, subject, message, dateline, readstatus, sentstatus )
                 VALUES ('', '$to', '$from', '$type', '$owner', '$folder', '$subject', '$message', '$onlinetime', '$isRead', '$isSent')" );
}
 ...
 **/
function u2u_send_multi_recp($msgto, $subject, $message) {
    global $db, $table_members, $self, $SETTINGS, $lang, $onlinetime, $bbname, $adminemail;
 ...
 * @return errors (if any)
 **/
function u2u_send_recp($msgto, $subject, $message) {
    global $db, $table_members, $self, $SETTINGS, $lang, $onlinetime, $bbname, $adminemail;
...
function u2u_send($u2uid, $msgto, $subject, $message, $u2upreview) {
    global $db, $self, $lang, $username, $table_u2u;
    ...
    if ( isset( $sendsubmit ) ) {
        ...
        if ( strstr( $msgto, "," ) ) {
            $errors = u2u_send_multi_recp($msgto, $subject, $message);
        } else {
            $errors = u2u_send_recp($msgto, $subject, $message);
        }
