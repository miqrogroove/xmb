<?php
/* $Id: today.php,v 1.9.2.27 2005/01/15 23:41:48 Daf Exp $ */
/*
    XMB 1.9
...
loadtemplates('error', 'footer_load', 'footer_querynum', 'footer_phpsql', 'footer_totaltime', 'today', 'today2', 'header', 'footer', 'css', 'today_multipage');
smcwcache();
