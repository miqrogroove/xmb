...
if($settings[usercstatus] == "on") {
$usercstatuson = "selected=\"selected\"";
} else {
$usercstatusoff = "selected=\"selected\"";
}
...
printsetting1("Custom User Status", "usercstatusnew", $usercstatuson, $usercstatusoff);
