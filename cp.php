...
<?
printsetting2($lang_bbname, "bbnamenew", $bbname, "50");
printsetting2($lang_textsitename, "sitenamenew", $sitename, "50");
printsetting2($lang_textsiteurl, "siteurlnew", $siteurl, "50");
printsetting2($lang_textboardurl, "boardurlnew", $boardurl, "50");
printsetting2($lang_adminemail, "adminemailnew", $adminemail, "50");
?>
...
<?
printsetting2($lang_textppp, "postperpagenew", $postperpage, "2");
printsetting2($lang_texttpp, "topicperpagenew", $topicperpage, "2");
printsetting2($lang_textmpp, "memberperpagenew", $memberperpage, "2");
printsetting2($lang_texthottopic, "hottopicnew", $hottopic, "2");
printsetting2($lang_textflood, "floodctrlnew", $floodctrl, "2");
printsetting2($lang_u2uquota, "u2uquotanew", $u2uquota, "2");
...
<td class="tablerow" bgcolor="<?=$altbg2?>"><textarea rows="5" name="bboffreasonnew" cols="50"><?=$bboffreason?></textarea></td>
</tr>
...
<td class="tablerow" bgcolor="<?=$altbg2?>"><textarea rows="5" name="bbrulestxtnew" cols="50"><?=$bbrulestxt?></textarea></td>
</tr>
...
printsetting2($lang_smtotal, "smtotalnew", $smtotal, "5");
printsetting2($lang_smcols, "smcolsnew", $smcols, "5");
?>
...
$db->query("DELETE FROM $table_settings");
$db->query("INSERT INTO $table_settings VALUES('$langfilenew', '$bbnamenew', '$postperpagenew', '$topicperpagenew', '$hottopicnew', '$themenew', '$bbstatusnew', '$whos_on', '$reg_on', '$bboffreasonnew', '$regviewnew', '$floodctrlnew', '$memberperpagenew', '$catsonlynew', '$hidepriv', '$emailchecknew', '$bbrulesnew', '$bbrulestxtnew', '$searchstatusnew', '$faqstatusnew', '$memliststatusnew', '$sitenamenew', '$siteurlnew', '$avastatusnew', '$u2uquotanew', '$gzipcompressnew', '$boardurlnew', '$coppanew', '$timeformatnew', '$adminemailnew', '$dateformatnew', '$sigbbcodenew', '$sightmlnew', '$reportpostnew', '$bbinsertnew', '$smileyinsertnew', '$doubleenew', '$smtotal', '$smcols')");
...
if($forum[private] == "2") {
$type32 = "selected=\"selected\"";
} elseif($forum[private] == "3") {
$type33 = "selected=\"selected\"";
} elseif($forum[private] == "4") {
$type34 = "selected=\"selected\"";
} elseif($forum[private] == "1") {
$type31 = "selected=\"selected\"";
}
...
<tr bgcolor="<?=$altbg2?>">
<td class="tablerow"><?=$lang_textallow?></td>
...
<option value="1" <?=$type11?>><?=$lang_textpermission1?></option>
<option value="2" <?=$type12?>><?=$lang_textpermission2?></option>
<option value="3" <?=$type13?>><?=$lang_textpermission3?></option>
<option value="4" <?=$type14?>><?=$lang_textpermission41?></option>
</td>
</tr>
...
<option value="1" <?=$type21?>><?=$lang_textpermission1?></option>
<option value="2" <?=$type22?>><?=$lang_textpermission2?></option>
<option value="3" <?=$type23?>><?=$lang_textpermission3?></option>
<option value="4" <?=$type24?>><?=$lang_textpermission41?></option>
</td>
</tr>

<tr bgcolor="<?=$altbg2?>">
<td class="tablerow"><?=$lang_whoview?></td>
<td><select name="privatenew">
<option value="1" <?=$type31?>><?=$lang_textpermission1?></option>
<option value="2" <?=$type32?>><?=$lang_textpermission2?></option>
<option value="3" <?=$type33?>><?=$lang_textpermission3?></option>
<option value="4" <?=$type34?>><?=$lang_textpermission42?></option>
</td>
</tr>
...
$db->query("INSERT INTO $table_forums VALUES ('forum', '', '$newfname', '$newfstatus', '', '', '$newforder', '1', '', 'no', 'yes', 'yes', '', '', '0', '0', '$newffup', '1', 'yes', 'on', 'on', '')");
}

if($newgname != $lang_textnewgroup) {
$db->query("INSERT INTO $table_forums VALUES ('group', '', '$newgname', '$newgstatus', '', '', '$newgorder', '', '', '', '', '', '', '', '0', '0', '', '', '', '', '', '')");
}

if($newsubname != $lang_textnewsubf) {
$db->query("INSERT INTO $table_forums VALUES ('sub', '', '$newsubname', '$newsubstatus', '', '', '$newsuborder', '1', '', 'no', 'yes', 'yes', '', '', '0', '0', '$newsubfup', '1', 'yes', 'on', 'on', '')");
}
...
$db->query("UPDATE $table_forums SET name='$namenew', description='$descnew', allowhtml='$allowhtmlnew', allowsmilies='$allowsmiliesnew', allowbbcode='$allowbbcodenew', theme='$themeforumnew', userlist='$userlistnew', private='$privatenew', postperm='$postperm1|$postperm2', allowimgcode='$allowimgcodenew', attachstatus='$attachstatusnew', pollstatus='$pollstatusnew', password='$passwordnew' WHERE fid='$fdetails'");
if($delete != "") {
...
<span class="smalltxt"><?=$lang_multmodnote?></span>
...
<td><input type="text" size="20" name="cusstatus<?=$member[uid]?>" value="<?=stripslashes($member[customstatus])?>" /></td>
</tr>
...
$db->query("UPDATE $table_members SET status='$status', customstatus='$newcustom'$queryadd WHERE uid='$mem[uid]'");
}
}
}
...
<tr bgcolor="<?=$altbg1?>">
<td colspan="3" class="tablerow"><?=$lang_textnewip?>
...
<span class="smalltxt"><?=$lang_currentip?> <b><?=$onlineip?></b><?=$warning?><br /><?=$lang_multipnote?></span>
<center><input type="submit" name="ipbansubmit" value="<?=$lang_textsubmitchanges?>" /></center>
</form>
