...
$tables = array('banned', 'buddys', 'favorites', 'forums', 'members', 'posts', 'ranks', 'settings', 'smilies', 'templates', 'themes', 'threads', 'u2u', 'whosonline', 'words');
...
$db->query("INSERT INTO $table_themes VALUES ( 'xmb1', '#ffffff', '#dededf', '#eeeeee', '#004455', '#778899', '#005555', '#ffffff', '#ffffff', '#dcdcde', '#003300', '#002200', '1', '94%', '4', 'Arial', '12px', 'logo1.gif', 'images/xmb1', 'images/smilies')");
echo "<b>Done</b><br>";
...
$db->query("INSERT INTO $table_smilies VALUES ( 'picon', '', 'bigsmile.gif', '')");
...
$db->query("INSERT INTO $table_settings VALUES('english', 'XMB Forums', '25', '30', '20', 'xmb1', 'on', 'on', 'on', '', 'off', '5', '45', 'off', 'on', 'off', 'off', '', 'on', 'on', 'on', 'XMBForum.com', 'http://www.xmbforum.com/', 'on', '75', 'off', 'http://www.xmbforum.com/xmb/', 'off', '12', 'kb9kss@xmbforum.com', 'mm-dd-yyyy', 'on', 'off', 'on', 'on', 'on', 'on', '16', '4')");
echo "<b>Done</b><br>";
