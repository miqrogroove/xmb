...
?>
  ...
  <div class="group" id="defaults">
   ...
   <div class="row">
    <div class="label"><?= $lang['texttheme'] ?></div>
    <div class="field"><?= $themelist ?></div>
   </div>
<?php
...
?>
   <div class="row">
    <div class="label"><?= $lang['texttimeformat'] ?></div>
    <div class="field"><input type="radio" value="24" name="timeformatnew" <?= $check24 ?> />&nbsp;<?= $lang['text24hour'] ?>&nbsp;<input type="radio" value="12" name="timeformatnew" <?= $check12 ?> />&nbsp;<?= $lang['text12hour'] ?></div>
   </div>
<?php
