...
?>
<div class="row">
 <div class="xmb-grid-form-field indent2">
  <span>
   <input type="checkbox" name="delete<?= $subforum['fid'] ?>" value="<?= $subforum['fid'] ?>" />&nbsp;
  </span>
  <span>
   <input type="text" name="name<?= $subforum['fid'] ?>" value="<?= $subforum['name'] ?>" /> &nbsp;
  </span>
  <span>
   <label><?= $lang['textorder'] ?> <input type="text" name="displayorder<?= $subforum['fid'] ?>" size="2" value="<?= $subforum['displayorder'] ?>" /></label> &nbsp;
  </span>
  <span>
...
?>
  ...
  <span>
   <a href="<?= $full_url ?>admin/forums.php?fdetails=<?= $subforum['fid'] ?>"><?= $lang['textmoreopts'] ?></a>
  </span>
 </div>
</div>
