...
<table cellspacing="0" cellpadding="0" border="0" width="100%" align="center" class="fdetails">
<tr>
...
<td bgcolor="<?= $THEME['altbg2'] ?>"><input type="text" name="namenew" size="50" value="<?= $forum['name']; ?>" /> <?= $lang['texthtmlis'] ?> <?= $lang['texton'] ?></td>
</tr>
<tr class="tablerow">
...
?></textarea> <?= $lang['texthtmlis'] ?> <?= $lang['texton'] ?></td>
</tr>
<tr class="tablerow">
