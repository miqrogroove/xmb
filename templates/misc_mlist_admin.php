...
<td colspan="6"><?= $lang['textsrchusr'] ?>&nbsp;&nbsp;<input type="text" size="15" name="srchmem" value="<?= $srchmem ?>" />&nbsp;&nbsp;<?= $lang['textsrchemail'] ?>&nbsp;&nbsp;<input type="text" size="15" name="srchemail" value="<?= $srchemail ?>" />&nbsp;&nbsp;<?= $lang['textsrchip'] ?>&nbsp;&nbsp;<input type="text" size="15" name="srchip" value="<?= $srchip ?>" />&nbsp;&nbsp;<input type="submit" class="submit" value="<?= $lang['textgo'] ?>" /></td>
</tr>
<?= $multipage ?>
</table>
</td>
