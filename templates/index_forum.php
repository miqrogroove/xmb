...
<td bgcolor="<?= $THEME['altbg2'] ?>" class="tablerow" width="54%"><a href="<?= $full_url ?>forumdisplay.php?fid=<?= $forum['fid'] ?>"><font class="mediumtxt"><strong><?= $forum['name'] ?></strong></font><br /><br /><font class="smalltxt"><?= $forum['description'] ?></font></a><span class="smalltxt plainlinks"><?= $forum['moderator'] ?></span><font class="smalltxt"><?= $subforums ?></font></td>
