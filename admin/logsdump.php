...
$core->nav($lang['textlogsdump']);
$core->setCanonicalLink('admin/logsdump.php');

if ($vars->settings['subject_in_title'] == 'on') {
    $template->threadSubject = $vars->lang['textlogsdump'] . ' - ';
}
...
if (onSubmit('nosubmit')) {
    ...
    $template->formURL = $vars->full_url . 'admin/logsdump.php';
