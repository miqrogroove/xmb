...
if (onSubmit('nosubmit')) {
    $core->request_secure('Control Panel/Check Tables', '', error_header: true);
    ...
    foreach($tables as $val) {
        $body .= $admin->dump_query($db->query('CHECK TABLE `' . $vars->tablepre . $val.'`'), header: $start);
