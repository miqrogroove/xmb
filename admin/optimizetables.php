...
$relpath = 'admin/optimizetables.php';
$title = $lang['optimize'];
...
if (onSubmit('nosubmit')) {
    $core->request_secure('Control Panel/Optimize Tables', '', error_header: true);
    ...
    $template->token = $token->create('Control Panel/Optimize Tables', '', $vars::NONCE_AYS_EXP);
    $template->prompt = $lang['optimize_confirm'];
