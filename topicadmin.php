...
echo "<div class=\"tablerow\">$lang_notpermitted</div>";
exit;
}
if($action == "delete") {
if(!$deletesubmit) {
...
echo "$lang_textnoaction";
exit;
}

$count = $db->query("SELECT COUNT(*) FROM $table_posts WHERE tid='$tid'");
$subtract = $db->result($count, 0);

$query = $db->query("SELECT type, fup FROM $table_forums WHERE fid='$fid'");
...
echo "<span class=\"mediumtxt \">$lang_deletethreadmsg</span>";
?>
<script>
function redirect() {
...
echo "<span class=\"mediumtxt \">$lang_closethreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
$query = $db->query("SELECT type, fid, fup FROM $table_forums WHERE fid='$moveto'");
$move = $db->fetch_array($query);

$query = $db->query("SELECT type, fid, fup FROM $table_forums WHERE fid='$fid'");
$this = $db->fetch_array($query);

$query = $db->query("SELECT COUNT(*) FROM $table_posts WHERE tid='$tid'");
$subtract = $db->result($query, 0);
...
echo "<span class=\"mediumtxt \">$lang_movethreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
echo "<span class=\"mediumtxt \">$lang_topthreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
if($status != "Administrator" && $status1 != "Moderator") {
echo "<span class=\"mediumtxt \">$lang_textnoip</span>";
}
else {
...
echo "<span class=\"mediumtxt \">$lang_bumpthreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
if($replies == 0) {
echo "<span class=\"mediumtxt \">$lang_cantsplit</span>";
exit;
}
...
echo "<span class=\"mediumtxt \">$lang_textnosubject</span>";
exit;
}
...
echo "<span class=\"mediumtxt \">$lang_splitthreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
echo "<span class=\"mediumtxt \">$lang_mergethreadmsg</span>";
?>
<script>
function redirect() {
window.location.replace("forumdisplay.php?fid=<?=$fid?>");
...
echo "<span class=\"mediumtxt \">$lang_reportmsg</span>";
?>
<script>
function redirect() {
...
echo "<span class=\"mediumtxt \">$lang_votemsg</span>";
?>
<script>
function redirect() {
window.location.replace("viewthread.php?tid=<?=$tid?>");
