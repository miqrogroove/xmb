<?php
/* $Id: tools.php,v 1.3.2.8 2006/09/20 10:15:31 Tularis Exp $ */
/*
    XMB 1.9.2
...
switch ($action) {
    ...
    case 'whosonlinedump':
        if (!isset($_POST['yessubmit'])) {
            echo '<tr style="background-color: '.$THEME['altbg2'].'" class="ctrtablerow"><td>'.$lang['whoodump_confirm'].'<br /><form action="tools.php?action=u2udump" method="post"><input type="submit" name="yessubmit" value="'.$lang['textyes'].'" /> - <input type="submit" name="yessubmit" value="'.$lang['textno'].'" /></form></td></tr>';
        } elseif ($lang['textyes'] == $yessubmit) {
