<?php
/* $Id: editprofile.php,v 1.3.2.17 2007/05/22 21:07:44 ajv Exp $ */
/*
...
if(!isset($_POST['editsubmit'])) {
    ...
    $member['uu_email'] = urlencode($member['email']);
