<?php
/* $Id: viewthread.php,v 1.3.2.35 2007/05/05 08:04:33 Tularis Exp $ */
/*
...
if (!$action) {
    ...
    while ($q = $db->fetch_array($queryranks)) {
        if ($q['title'] == 'Super Administrator' || $q['title'] == 'Administrator' || $q['title'] == 'Super Moderator' || $q['title'] == 'Moderator') {
            $specialrank[$q['title']] = $q;
        } else {
            $rankposts[$q['posts']]  = $q;
        }
    }
