...
*/
    ...
    $versioncompany     = 'The XMB Group. Financially supported by iEntry Inc.';
    $versionshort       = "XMB 1.9.7";
    $versiongeneral     = 'XMB 1.9.7 Nexus';
    $copyright          = '2002-2007';
    $versionbuild       = 200704021900;
...
// Get themes, [fid, [tid]]
    if (isset($tid) && $action != 'templates') {
        ...
        if($SETTINGS['subject_in_title'] == 'on') {
            btitle(stripslashes($locate['subject']), true);
        }
    }elseif (isset($fid)) {
...
// Create the debug header, but only if debug is turned on

$debugheader = '';
if ( defined('DEBUG') && DEBUG ) {
    $debugheader = "<!-- $versionlong  --><!-- Build: $versionbuild --><!-- $versioncompany --><!-- www.xmbforum.com :: www.ientry.com -->";
}  
