<?php
/* $Id: Base.lang.php,v 1.1.2.21 2007/06/14 16:06:26 ajv Exp $ */
/*
...
$lang['attachmentsdeleted'] = "Attachment(s) deleted successfully";
...
$lang['copyright'] = '(C) 2002 - 2007 XMB Group';
...
$lang['emailregpw'] = "Thank you for registering. <br />A password has been created for you. Your login credentials have been sent to the by you provided e-mail address.";
...
$lang['evalstats1'] = '$lang["stats1"] = "On the $SETTINGS[bbname], there are:";';
...
$lang['evaluqinfo'] = '$lang["uqinfo"] = "You have $u2ucount U2Us. This is $percent% of the maximum, the maximum is set to $SETTINGS[u2uquota].";';
...
$lang['favaddedmsg'] = "The thread has successfully been added to your favourites list. You will now be taken to it.";
...
$lang['filecorrupt'] = "The file you are trying to download appears corrupt.<br /><br />&raquo; File download aborted.";
...
$lang['hottopic'] = "more than $SETTINGS[hottopic] replies";
...
$lang['max_daily_regs'] = "Maximum number of new registrations per day. Set to 0 for unlimited registrations per day";
...
$lang['misconlinetoday2'] = " members have visited $SETTINGS[bbname] today...";
$lang['month1'] = "a month";
...
$lang['noadminsession2'] = "Welcome to the administration control panel for XMB 1.9, currently running $SETTINGS[bbname].";
$lang['noadminsession3'] = "Please enter your username and password which currently has administration status.";
$lang['noadminsession4'] = "If you still have issues logging in, please contact the board <strong><a href=\"mailto:$SETTINGS[adminemail]?subject=Admin Login Failure At $SETTINGS[bbname]\">webmaster</a></strong>";
$lang['noban'] = "Nothing";
...
$lang['prunemsg'] = "This tool is used to prune the forums of posts, and threads. Please note that any pruning you do will delete posts from your specified forum! Creating a database backup is encouraged.";
$lang['prunenormal'] = "Normal Posts";
$lang['pruneposttypes'] = "Prune these: ";
$lang['prunetopped'] = "Topped Posts";
$lang['pruneusers'] = "The number of days after which a new user, who has never logged in, will be deleted. Set to 0 to disable.";
...
$lang['rulesoninfo'] = "The <a href=\"mailto:$SETTINGS[adminemail]\"> board administrator</a> has requested that all new registered users must agree to the following terms before registering and using the services on the board \"$SETTINGS[bbname]\". Please read the following terms and if you agree to them, select the \"I agree\" button found at the bottom of the terms.";
...
$lang['textaccessCP'] = 'Accessing Administration Panel';
$lang['textaccessTools'] = 'Using Administration Tools';
$lang['textaccessU2UAdmin'] = 'Accessing user U2U\'s';
...
$lang['textfaqans9'] = "First click on the <a href=\"u2u.php\">U2U</a> button in the menu, another smaller window will pop-up, from there you can access the 'Send a U2U' screen, by clicking on it at the top. Place the users name in the 'To' field, and then insert a subject and a message and click 'Send'. ";
...
$lang['textsubbody'] = "has replied to a thread you have subscribed to at $SETTINGS[bbname].\nTo stop receiving these notifications, please login to your member control panel.\n\nYou can visit the thread by going to\n\n";
...
$lang['textuseEditProfile'] = 'Editing user profile';
...
$lang['textyourpwis'] = "This is an automatic e-mail. Your new login credentials for $SETTINGS[bbname] can be found below:";
...
$lang['u2uattachstatus'] = "U2U Attachments Status:";
...
$lang['whosoneval'] = '$lang["whosonmsg"] = "There are currently $guestn, $membern and $hiddenn browsing $SETTINGS[bbname]";';
