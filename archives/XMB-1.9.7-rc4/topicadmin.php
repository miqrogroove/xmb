<?php
/* $Id: topicadmin.php,v 1.3.2.24 2007/05/22 21:07:45 ajv Exp $    */
/*
...
class mod {
    ...
    */
    function statuscheck($fid) {
        ...
        $query   = $db->query("SELECT fid, postperm, userlist, password, moderator FROM $table_forums WHERE fid=$fid");
    ...
    */
    function create_tid_string($tid=0, $thread_select=0) {
        $tids = '';
        $tid = (int) $tid;
        if ( $tid > 0 ) {
            $tids = $tid;
...
// Start actions...
    ...
    if (X_ADMIN) {
        ...
        <tr class="altbg1"><td class="tablerow">
