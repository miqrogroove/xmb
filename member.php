...
$dir1 = opendir("$imgdir/avatars");
while($avatar1 = readdir($dir1)) {
if(is_file("$imgdir/avatars/$avatar1")) {
$avatars .= " <option value=\"$imgdir/avatars/$avatar1\" />$avatar1</option>  ";
}
}
closedir($dir1);
...
echo "<span class=\"mediumtxt \">$lang_alreadyreg</span>";
exit;
}
if($emailcheck == "on"){
...
echo "<span class=\"mediumtxt \">$lang_pwnomatch</span>";
exit;
}
...
if(!strstr($email, "@")) {
echo "<span class=\"mediumtxt \">$lang_bademail</span>";
exit;
}
...
echo "<span class=\"mediumtxt \">$lang_regged</span>";

?>
<form method="post" action="misc.php?action=reglogin">
