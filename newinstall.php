...
echo "<b>Done</b> with ".$tablepre."templates :)<br /><br />Now  we'll begin inserting the default settings into ".$tablepre."settings...";
	$db->query("INSERT INTO ".$tablepre."settings VALUES ('english', 'XMB Forums', 25, 30, 20, 'XP-Blue', 'on', 'on', 'on', '', 'off', 5, 45, 'off', 'on', 'off', 'off', '', 'on', 'on', 'on', 'XMBForum.com', 'http://www.xmbforum.com/', 'on', 75, 'off', 'http://forums.xmbforum.com/xmb/', 'off', 12, 'admin@domain.com', 'mm-dd-yyyy', 'on', 'off', 'on', 'on', 'on', 'on', '16', '4', 'off', 'on', 'on');");
...
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb2', 'background.gif', '#e3e3ea', '#eeeef6', '#404060', '#404060', '#ffffff', '#505070', '#ffffff', '', 'category3.jpg', '#000033', '#000022', '1', '95%', '6', 'Arial', '12px', 'logo1.gif', 'images/xmb2', 'images/smilies', '');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb3', 'background.gif', '#ffdd00', '#ffe000', '#cc0000', '#cc0000', '#0000cc', '#0000aa', '#ffdd00', '#ffffff', '#ffcf00', '#000099', '#0000cc', '1', '95%', '6', 'Arial', '12px', 'logo.jpg', 'images/xmb3', 'images/smilies', '');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb1b', '#000000', '#220022', '#330033', '#bb44ff', '#bb44ff', '#000000', '#880099', '#ffccff', '#000000', '#110011', '#eebbee', '#cc00ff', '1', '95%', '6', 'Arial', '12px', 'logo.jpg', 'images/xmb1b', 'images/smilies', '');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb2b', '#000000', '#222240', '#333350', '#ddddff', '#ddddff', '#000000', '#777799', '#222233', '#000000', '#000000', '#eeeeff', '#ccccee', '1', '85%', '6', 'Arial', '12px', 'logo.gif', 'images/xmb2b', 'images/smilies', '#ccccee');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb3b', '#000000', '#608876', '#709986', '#ddf0dd', '#ddf0dd', '#000000', '#557766', '#eeffee', '#000000', '#305550', '#eeffee', '#eeffee', '1', '95%', '6', 'arial', '12px', 'logo.swf,170,80', 'images/xmb1', 'images/smilies', '');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb4', '#ffffff', '#E6E6E6', '#D6D6D6', '#000000', '#000000', '#000000', '#2663E2', '#FFFFFF', '#FFFFFF', '#E6E6E6', '#000000', '#000000', '1', '99%', '4', 'Trebuchet MS', '12px', 'logo1.jpg', 'images/xp', 'images/smilies', '');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('XP-Blue', '#FFFFFF', '#F4F3E8', '#EDECD8', '#000000', '#FFFFFF', '#2663E2', '#2663E2', '#FFFFFF', '#FFFFFF', '#2663E2', '#000000', '#000000', '1', '98%', '4', 'Trebuchet MS', '12px', 'logo15.jpg', 'images/xp', 'images/smilies', '#ffffff');");
...
$db->query("INSERT INTO ".$tablepre."themes VALUES ('XHalloween', '#000000', '#330000', '#440000', '#ff9900', '#ffaa00', '#000000', '#ff9900', '#000000', '#ffffff', '#cc5500', '#ff9900', '#ff9900', '1', '94%', '4', 'arial', '12px', '../../../wj/pumpkin.gif', 'images/xmb1', 'images/smilies', '');");
...
$db->query("INSERT INTO ".$tablepre."themes VALUES ('Xmb-Christmas', 'snowflakes.gif', '#fffcfc', '#fcfffc', '#ff0000', NULL, '#ddccaa', '#ee0000', '#ffffff', '#ffffff', '#00ee00', '#0000000', '#0000000', '1', '90%', '4', 'arial', '12px', 'christmas.jpg', 'images/xp', 'images/smilies', '#ffffff');");
$db->query("INSERT INTO ".$tablepre."themes VALUES ('xmb grunge', 'background.jpg', '#605E52', '#6D7167', '#D1D1D1', '0', '#353F40', '#262D2E', '#D1D1D1', '#605E52', '#353F40', '#90A9A5', '#D1D1D1', '1', '97%', '5', 'Arial', '11px', 'xmb1.gif', 'images/grunge', 'images/smilies', '#D1D1D1');");
