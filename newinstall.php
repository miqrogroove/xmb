...
echo "<b>Done</b> with ".$tablepre."templates :)<br /><br />Now  we'll begin inserting the default settings into ".$tablepre."settings...";
	$db->query("INSERT INTO ".$tablepre."settings VALUES ('English', 'XMB Forums', 25, 30, 20, 'XP-Blue', 'on', 'on', 'on', '', 'off', 5, 45, 'off', 'on', 'off', 'off', '', 'on', 'on', 'on', 'XMBForum.com', 'http://www.xmbforum.com/', 'on', 75, 'off', 'http://forums.xmbforum.com/xmb/', 'off', 12, 'admin@domain.com', 'mm-dd-yyyy', 'on', 'off', 'on', 'on', 'on', 'on', '16', '4', 'off', 'on', 'on', 'off');");
