...
echo "Installing XMB 1.8 Partagium<br /><br />Creating ".$tablepre."attachments<br>";
...
echo "Inserting data into ".$tablepre."ranks<br>";
        ...
        $db->query("INSERT INTO ".$tablepre."ranks VALUES ('Super Administrator', 0, 9, 9, 'yes', '');");
...
echo "Inserting data into ".$tablepre."words<br>";
        ...
        $db->query("INSERT INTO ".$tablepre."words VALUES ('fuck', '<b>[Censored]</b>', 1);");
        $db->query("INSERT INTO ".$tablepre."words VALUES ('shit', '<b>[Censored]</b>', 2);");
        $db->query("INSERT INTO ".$tablepre."words VALUES ('cock', '<b>[Censored]</b>', 3);");
        $db->query("INSERT INTO ".$tablepre."words VALUES ('ass', '<b>[Censored]</b>', 4);");
        $db->query("INSERT INTO ".$tablepre."words VALUES ('dick', '<b>[Censored]</b>', 5);");
        $db->query("INSERT INTO ".$tablepre."words VALUES ('faggot', '<b>[Censored]</b>', 6);");
...
echo "Inserting data into ".$tablepre."themes<br>";
        ...
        $db->query("INSERT INTO ".$tablepre."settings VALUES ('English', 'Your Forums', 25, 30, 20, 'Windows XP Silver', 'on', 'on', 'on', '', 'off', 5, 45, 'off', 'on', 'off', 'off', '', 'on', 'on', 'on', 'YourDomain.com', 'http://www.yourdomain.com/home', 'on', 600, 'on', 'http://www.yourdomain.com/forum/', 'off', 12, 'webmaster@yourdomain.com', 'dd-mm-yyyy', 'on', 'off', 'on', 'on', 'on', 'off', '16', '4', 'off', 'on', 'on', 'on', 'on', 'on', 'on', '<b>Welcome to your new boards!!</b>\r\nFirst, register yourself, you will be made admin.\r\nAfter this, modify your board to your own taste, we recommend starting with changing the settings...!', '4000');");

echo "Performing general modifications to the tables...<br>";
        ...
        $db->query("create index ip4 on ".$tablepre."banned (ip4);");
