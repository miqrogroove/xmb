<?php
/**
* $Id: u2u.inc.php,v 1.1.2.22 2007/01/28 01:57:25 FunForum Exp $
*/
...
function u2u_msg($msg, $redirect) {
    global $THEME, $u2uheader, $u2ufooter;
...
function db_u2u_insert($to, $from, $type, $owner, $folder, $subject, $message, $isRead, $isSent) {
    ...
    $subject = checkInput(addslashes($subject));
...
function u2u_send_multi_recp($msgto, $subject, $message, $u2uid=0) {
    global $THEME, $db, $table_members, $self, $SETTINGS, $lang, $onlinetime, $table_u2u;
...
function u2u_send_recp($msgto, $subject, $message, $u2uid=0) {
    global $db, $table_members, $self, $SETTINGS, $lang, $onlinetime, $table_u2u, $del;
...
function u2u_send($u2uid, $msgto, $subject, $message, $u2upreview) {
    global $THEME, $db, $self, $lang, $username, $SETTINGS, $table_u2u, $del;
    global $u2uheader, $u2ufooter, $u2ucount;
    ...
    if ( $SETTINGS['u2ucount'] >= $u2uquota && $u2uquota > 0 ) {
...
function u2u_view($u2uid, $folders) {
    global $THEME, $db, $dateformat, $timecode, $thewidth, $lang;
...
function u2u_print($u2uid, $eMail = false) {
    global $THEME, $SETTINGS, $css, $db, $self, $table_u2u, $lang, $u2uheader, $u2ufooter, $charset, $logo;
    ...
    if ( $u2u ) {
        ...
        $u2umessage     = postify(stripslashes($u2u['message']), 'no', 'no', 'yes', 'no', 'yes', 'no', false, "no", "yes");
        $u2ufolder      = $u2u['folder'];
        $u2ufrom        = $u2u['msgfrom'];
        ...
        if ($eMail) {
            ...
            altMail($self['email'], $lang['textu2utoemail'] . " " . $u2usubject, $email, 'From: '.$SETTINGS['bbname'].' <'.$self['email'].">\r\n".'Content-type: text/html');
...
function u2u_ignore() {
    global $THEME;
    global $ignorelist, $ignoresubmit, $self, $lang, $db, $table_members, $thewidth;
...
function u2u_display($folder, $folders) {
    global $THEME, $db, $self, $table_u2u, $table_whosonline, $lang, $thewidth;
...
function u2u_folderList() {
    global $THEME, $db, $self, $lang, $table_u2u;
