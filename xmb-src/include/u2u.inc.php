<?php
/**
* $Id: u2u.inc.php,v 1.1.2.9 2005/11/06 01:18:49 Tularis Exp $
*/
...
function u2u_print($u2uid, $eMail = false) {
    global $db, $self, $table_u2u, $timeoffset, $lang, $u2uheader, $u2ufooter, $dateformat, $timecode, $addtime, $charset, $bbname, $logo;
