<?php
/* $Id: member.php,v 1.3.2.43 2007/03/11 14:52:51 FunForum Exp $ */
/*
...
if ($action == "coppa") {
    ...
    if (!isset($regsubmit)) {
        ...
        if(!in_array(basename($newlangfile).'.lang.php', $lfs)) {
            $newlangfile = $SETTINGS['langfile'];
        } else {
            $newlangfile = basename($newlangfile);
        }
