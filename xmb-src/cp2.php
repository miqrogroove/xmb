<?php
/* $Id: cp2.php,v 1.3.2.27 2007/03/01 20:39:36 FunForum Exp $ */
/*
...
if ($action == "restrictions") {
    if (!isset($restrictedsubmit)) {
        ...
        <tr class="category">
        <td><span class="smalltxt"><strong><font style="color: <?php echo $THEME['cattext']?>"><?php echo $lang['textdeleteques']?></font></strong></span></td>
        <td><span class="smalltxt"><strong><font style="color: <?php echo $THEME['cattext']?>"><?php echo $lang['restrictedname']?></font></strong></span></td>
        <td><span class="smalltxt"><strong><font style="color: <?php echo $THEME['cattext']?>"><?php echo $lang['case_sensitive']?></font></strong></span></td>
        <td><span class="smalltxt"><strong><font style="color: <?php echo $THEME['cattext']?>"><?php echo $lang['partial_match']?></font></strong></span></td>
        </tr>
        ...
        while ($restricted = $db->fetch_array($query)) {
            ...
            ?>
            <tr class="tablerow">
            <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="checkbox" name="delete<?php echo $restricted['id']?>" value="<?php echo $restricted['id']?>" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" size="30" name="name<?php echo $restricted['id']?>" value="<?php echo $restricted['name']?>" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="checkbox" name="case<?php echo $restricted['id']?>" value="<?php echo $restricted['id']?>" <?php echo $case_check?> /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="checkbox" name="partial<?php echo $restricted['id']?>" value="<?php echo $restricted['id']?>" <?php echo $partial_check?> /></td>
            </tr>
            <?php
        }
        ...
        ?>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" colspan="4"><img src="<?php echo ROOT?>images/pixel.gif" alt="" /></td>
        </tr>
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg2']?>" colspan="4" align="left">
        <table border="0" width="100%">
        <tr class="category">
        <td colspan="2"><span class="smalltxt"><strong><font style="color: <?php echo $THEME['cattext']?>"><?php echo $lang['textnewcode']?></font></strong></span></td>
        </tr>
        <tr class="tablerow">
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['restrictedupdate'].'</td></tr>';
...
elseif ($action == "themes") {
    if (!isset($themesubmit) && !isset($single) && !isset($importsubmit)) {
        ...
        while ($themeinfo = $db->fetch_array($query)) {
            ...
            <tr style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow">
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="3"><input type="submit" name="themesubmit" value="<?php echo $lang['textsubmitchanges']?>" class="submit" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <tr class="tablerow">
        <td style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['textthemefile']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input name="themefile" type="file" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="2"><input type="submit" class="submit" name="importsubmit" value="<?php echo $lang['textimportsubmit']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">';
        if (!$query) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['themeupdate'].'</td></tr>';
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="3"><input type="submit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /><input type="hidden" name="orig" value="<?php echo $single?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" align="center" colspan="2"><input class="submit" type="submit" value="<?php echo $lang['textsubmitchanges']?>" /><input type="hidden" name="newtheme" value="<?php echo $single?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        $field_list = array('bgcolor', 'altbg1', 'altbg2', 'link', 'bordercolor', 'header', 'headertext', 'catcolor', 'tabletext', 'text', 'cattext');
        foreach($field_list as $field) {
            ${$field.'new'} = preg_replace('#^[0-9a-f]{3,6}$#i', '#$0', ${$field.'new'});
        }
...
elseif ($action == "smilies") {
    if (!isset($smiliesubmit)) {
        ...
        while ($smilie = $db->fetch_array($query)) {
            ?>
            <tr>
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><input type="checkbox" name="smdelete[<?php echo $smilie['id']?>]" value="1" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="smcode[<?php echo $smilie['id']?>]" value="<?php echo $smilie['code']?>" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="smurl[<?php echo $smilie['id']?>]" value="<?php echo $smilie['url']?>" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><img src="<?php echo $THEME['smdir']?>/<?php echo $smilie['url']?>" alt="<?php echo $smilie['code']?>" /></td>
            </tr>
            <?php
        }
        ...
        ?>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" colspan="4"><img src="./images/pixel.gif" alt="" /></td>
        </tr>
        <tr style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow">
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" colspan="4" align="left"><img src="<?php echo ROOT?>images/pixel.gif" alt="" /></td>
        </tr>
        <tr>
        ...
        $query = $db->query("SELECT * FROM $table_smilies WHERE type='picon' ORDER BY id");
            ...
            <tr>
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><input type="checkbox" name="pidelete[<?php echo $smilie['id']?>]" value="1" /></td>
            <td colspan="2" align="left" style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="piurl[<?php echo $smilie['id']?>]" value="<?php echo $smilie['url']?>" /></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" align="center" class="tablerow"><img src="<?php echo $THEME['smdir']?>/<?php echo $smilie['url']?>" alt="<?php echo $smilie['url']?>" /></td>
            </tr>
        ...
        <tr>
        <td align="center" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="4"><input type="submit" class="submit" name="smiliesubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['smilieupdate'].'</td></tr>';
    }
}
...
elseif ($action == "censor") {
    ...
    <tr>
    <td align="center" colspan="3" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="submit" class="submit" name="censorsubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
    </tr>
    </table>
    </td>
    </tr>
...
if (isset($censorsubmit)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['censorupdate'].'</td></tr>';
    }
    ...
    if (!isset($rankssubmit)) {
        ...
        <tr style="background-color: <?php echo $THEME['altbg2']?>"><td colspan="6"> </td></tr>
        <tr style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow">
        ...
        <tr>
        <td align="center" colspan="6" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="submit" name="rankssubmit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['rankingsupdate'].'</td></tr>';
    }
    ...
    if (!isset($newslettersubmit)) {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow"><?php echo $lang['textsubject']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="text" name="newssubject" size="80" style="background-color: <?php echo $THEME['altbg1']?>" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" valign="top"><?php echo $lang['textmessage']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><textarea cols="80" rows="10" name="newsmessage" style="background-color: <?php echo $THEME['altbg1']?>" ></textarea></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" valign="top"><?php echo $lang['textsendvia']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="radio" value="email" name="sendvia" style="background-color: <?php echo $THEME['altbg1']?>" /> <?php echo $lang['textemail']?><br /><input type="radio" value="u2u" checked="checked" name="sendvia" style="background-color: <?php echo $THEME['altbg1']?>" /> <?php echo $lang['textu2u']?></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" valign="top"><?php echo $lang['textsendto']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow"><input type="radio" value="all" checked="checked" name="to" /> <?php echo $lang['textsendall']?><br />
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" valign="top"><?php echo $lang['textfaqextra']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow">
        <input type="checkbox" value="yes" checked="checked" name="newscopy" /> <?php echo $lang['newsreccopy']?><br />
        <select name="wait" style="background-color: <?php echo $THEME['altbg1']?>">
        ...
        <tr>
        <td align="center" colspan="2" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><input type="submit" class="submit" name="newslettersubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['newslettersubmit'].'</td></tr>';
    }
}
...
elseif ($action == "prune") {
    if (!isset($_POST['pruneSubmit'])) {
        ...
        <tr>
        <td style="width: <?php echo $THEME['tablewidth']?>; background-color: <?php echo $THEME['altbg1']?>" class="tablerow"><strong><?php echo $lang['prunemsg'];?></strong></td>
        </tr>
        <tr style="background-color: <?php echo $THEME['altbg2']?>">
        <td align="center">
        ...
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>;">
        <?php echo $lang['pruneby']?>
        </td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>;">
        <table>
        <tr>
        <td>
        ...
        <tr>
        <td class="ctrtablerow" style="background-color: <?php echo $THEME['altbg2']?>;" colspan="2"><input type="submit" name="pruneSubmit" value="<?php echo $lang['textprune']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['forumpruned'].'</td></tr>';
    }
}
...
elseif ($action == "templates") {
    ...
    if (isset($restore)) {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="ctrtablerow"><?php echo $lang['templaterestoreconfirm']?></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><input type="submit" class="submit" name="restoresubmit" value="<?php echo $lang['textyes']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    if (isset($restoresubmit)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['templatesrestoredone'].'</td></tr>';
    }
    ...
    if (isset($edit) && !isset($editsubmit)) {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><?php echo $lang['templatename']?>&nbsp;<strong><?php echo $template['name']?></strong></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="ctrtablerow">
        <textarea cols="100" rows="30" name="templatenew"><?php echo $template['template']?></textarea></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><input type="submit" name="editsubmit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /></strong></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    if (isset($editsubmit)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['templatesupdate'].'</td></tr>';
    }
    ...
    if (isset($delete)) {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="ctrtablerow"><?php echo $lang['templatedelconfirm']?></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><input type="submit" class="submit" name="deletesubmit" value="<?php echo $lang['textyes']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    if (isset($deletesubmit)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['templatesdelete'].'</td></tr>';
    }
    ...
    if (isset($new)) {
        ...
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><?php echo $lang['templatename']?>&nbsp;<input type="text" name="namenew" size="30" value="<?php echo $newtemplatename?>" /></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg1']?>" class="ctrtablerow"><textarea cols="100" rows="30" name="templatenew"></textarea></td>
        </tr>
        <tr>
        <td style="background-color: <?php echo $THEME['altbg2']?>" class="ctrtablerow"><input type="submit" name="editsubmit" value="<?php echo $lang['textsubmitchanges']?>" class="submit" /></td>
        </tr>
        </table>
        </td>
        </tr>
...
elseif ($action == "attachments") {
    if (!isset($attachsubmit) && !isset($searchsubmit)) {
        ...
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwherename']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="filename" size="30" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwhereauthor']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="author" size="40" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwhereforum']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><?php echo $forumselect?></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwheresizesmaller']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="sizeless" size="20" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwheresizegreater']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="sizemore" size="20" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwheredlcountsmaller']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="dlcountless" size="20" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwheredlcountgreater']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="dlcountmore" size="20" /></td>
        </tr>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $lang['attachmanwheredaysold']?></td>
        <td style="background-color: <?php echo $THEME['altbg2']?>"><input type="text" name="daysold" size="20" /></td>
        </tr>
        <tr>
        <td align="center" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="2"><input type="submit" name="searchsubmit" class="submit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    if (isset($searchsubmit)) {
        ...
        $query = $db->query("SELECT a.*, p.*, t.tid, t.subject AS tsubject, f.name AS fname FROM $table_attachments a, $table_posts p, $table_threads t, $table_forums f WHERE a.pid=p.pid AND t.tid=a.tid AND f.fid=p.fid $restriction $orderby");
            ...
            ?>
            <tr>
            <td style="background-color: <?php echo $THEME['altbg1']?>" class="tablerow" align="center" valign="middle"><a href="cp2.php?action=delete_attachment&amp;aid=<?php echo $attachment['aid']?>">Delete</a>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><input type="text" name="filename<?php echo $attachment['aid']?>" value="<?php echo $attachment['filename']?>"><br /><span class="smalltxt"><a href="viewthread.php?action=attachment&amp;tid=<?php echo $attachment['tid']?>&amp;pid=<?php echo $attachment['pid']?>" target="_blank"><?php echo $lang['textdownload']?></a></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><?php echo $attachment['author']?></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" valign="top"><a href="viewthread.php?tid=<?php echo $attachment[tid]?>"><?php echo $attachment['tsubject']?></a><br /><span class="smalltxt"><?php echo $lang['textinforum']?> <a href="forumdisplay.php?fid=<?php echo $attachment['fid']?>"><?php echo $attachment['fname']?></a></span></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" valign="top" align="center"><?php echo $attachsize?></td>
            <td style="background-color: <?php echo $THEME['altbg2']?>" class="tablerow" valign="top" align="center"><?php echo $attachment['downloads']?></td>
            </tr>
            <?php
        ...
        ?>
        <tr>
        <td align="center" class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>" colspan="6"><input class="submit" type="submit" name="deletesubmit" value="<?php echo $lang['textsubmitchanges']?>" /></td>
        </tr>
        </table>
        </td>
        </tr>
    ...
    if (isset($deletesubmit)) {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['textattachmentsupdate'].'</td></tr>';
    }
}
...
elseif ($action == "modlog") {
    ...
    function splitModLogData($username, $action, $data, $dateline) {
        ...
        $res        = array();
        $ip         = '';
        $details    = array('<table class="dataTable">');
    ...
    while ($recordinfo = $db->fetch_array($query)) {
        ...
        ?>
        <tr>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><a href="./member.php?action=viewpro&amp;member=<?php echo urlencode($data['username'])?>"><?php echo htmlspecialchars($data['username'])?></a></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg2']?>"><?php echo $data['dateline']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $data['ip']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $data['action']?></td>
        <td class="tablerow" style="background-color: <?php echo $THEME['altbg1']?>"><?php echo $data['details']?></td>
        </tr>
        <?php
    }
...
elseif ($action == 'restore_attachments') {
    ...
    if (!is_readable('./attachments')) {
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$lang['error_chmod_attach_dir'].'</td></tr>';
    } else {
        ...
        echo '<tr style="background-color: '.$THEME['altbg2'].'" class="tablerow"><td align="center">'.$i.' '.$lang['attachments_num_restored'].'</td></tr>';
    }
}
