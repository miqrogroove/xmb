<?php
/* $Id: editprofile.php,v 1.9 2006/02/24 18:36:41 Tularis Exp $ */
/*
    XMB 1.10
...
// Pre-load templates
loadtemplates('footer_load','footer_querynum','footer_phpsql','footer_totaltime','memcp_profile_avatarurl','memcp_profile_avatarlist','admintool_editprofile');
...
else
{
    ...
    $sig            = safeAddslashes($newsig);
    $bio            = safeAddslashes($bio);
    $memlocation    = safeAddslashes($newmemlocation);
