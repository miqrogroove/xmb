<?php
/* $Id: index.php,v 1.12 2006/02/01 15:42:24 Tularis Exp $ */
/*
    XMB 1.10
...
if($SETTINGS['tickerstatus'] == "on") {
    $SETTINGS['tickercontents'] = str_replace("\r\n", "\n", $SETTINGS['tickercontents']);   // make windows-strings compatible
    $SETTINGS['tickercontents'] = str_replace("\r",   "\n", $SETTINGS['tickercontents']);   // make macOS-strings compatible
    $news       = array();
    $news       = explode("\n", $SETTINGS['tickercontents']);                               // use UNIX-style
    ...
    for($i=0;$i<count($news);$i++) {
        ...
        $news[$i]  = str_replace('\"', '"', safeAddslashes($news[$i]));
...
if (0 !== ($gid = safeInt(fetchFromRequest('gid', X_POST), 1))) {
    // hard-code whosonline status in this case
...
$footerads = '<a href="http://www.ecoupons.com">eCoupons.com</a> - The largest source of <a href="http://www.ecoupons.com">Coupons</a>, <a href="http://www.ecoupons.com">Printable Coupons</a> and <a href="http://www.ecoupons.com">Coupon Codes</a> online.<br />';
end_time();
