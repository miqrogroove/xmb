<?php
/* $Id: post.php,v 1.24 2006/08/28 15:09:10 Roxas Exp $ */
/*
    XMB 1.10
...
loadtemplates('post_notloggedin', 'post_loggedin', 'post_preview', 'post_attachmentbox', 'post_newthread', 'post_reply_review_toolong', 'post_reply_review_post', 'post_reply', 'post_edit', 'functions_smilieinsert', 'functions_smilieinsert_smilie', 'functions_bbcodeinsert', 'forumdisplay_password', 'functions_bbcode', 'post_newpoll', 'spelling_suggestion_new', 'spelling_suggestion_row', 'spelling_suggestion', 'spelling_suggestion_no', 'post_edit_attachment', 'post_edit_attachment');
