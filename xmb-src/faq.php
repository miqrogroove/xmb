<?php
/* $Id: faq.php,v 1.3.2.2 2005/09/16 09:38:53 Tularis Exp $ */
/*
    XMB 1.9.2
...
if ($faqstatus != "on" && $page != 'forumrules') {
    loadtemplates('misc_feature_notavailable', 'footer_querynum', 'footer_phpsql', 'footer_totaltime', 'footer_load');
