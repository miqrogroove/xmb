<?php
/* $Id: memcp.php,v 1.3.2.32 2007/06/13 23:59:23 ajv Exp $ */
/*
...
function makenav($current) {
    ...
    if ($current == "") {
        echo '<td class="ctrtablerow altbg1" width="15%">'.$lang['textmyhome'].'</td>';
    } else {
        echo '<td class="ctrtablerow altbg2" width="15%"><a href="memcp.php">'.$lang['textmyhome'].'</a></td>';
    }

    if ($current == "profile") {
        echo '<td class="ctrtablerow altbg1" width="15%">'.$lang['texteditpro'].'</td>';
    } else {
        echo '<td class="ctrtablerow altbg2" width="15%"><a href="memcp.php?action=profile">'.$lang['texteditpro'].'</a></td>';
    }

    if ($current == "subscriptions") {
        echo '<td class="ctrtablerow altbg1" width="15%">'.$lang['textsubscriptions'].'</td>';
    } else {
        echo '<td class="ctrtablerow altbg2" width="15%"><a href="memcp.php?action=subscriptions">'.$lang['textsubscriptions'].'</a></td>';
    }

    if ($current == "favorites") {
        echo '<td class="ctrtablerow altbg1" width="15%">'.$lang['textfavorites'].'</td>';
    } else {
        echo '<td class="ctrtablerow altbg2" width="15%"><a href="memcp.php?action=favorites">'.$lang['textfavorites'].'</a></td>';
    }

    echo '<td width="20%" class="ctrtablerow altbg2"><a href="u2u.php">'.$lang['textu2umessenger']. '</a></td>';
    echo '<td class="ctrtablerow altbg2" width="15%"><a href="buddy.php" target="buddyWindow" onclick="Popup(this.href, \'buddyWindow\', 720, 450); return false;">'.$lang['textbuddylist'].'</a></td>';
    echo '<td width="10%" class="ctrtablerow altbg2"><a href="faq.php">'.$lang['helpbar'].'</a></td>';
...
if ($action == "profile") {
    ...
    if (isset($editsubmit)) {
        ...
        $icq            = (is_numeric($newicq) && $newicq > 0) ? $newicq : 0;
