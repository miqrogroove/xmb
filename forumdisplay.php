...
$querytop = mysql_query("SELECT * FROM $table_threads WHERE fid='$fid' $cusdate ORDER BY topped $ascdesc,lastpost $ascdesc LIMIT $start_limit, $tpp") or die(mysql_error()); 
