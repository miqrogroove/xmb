...
$db->query("INSERT INTO $table_u2u VALUES('', '$msgto', '$username', '" . time() . "', '$subject', '$message', 'inbox')");
if($saveoutbox == "yes") {
$db->query("INSERT INTO $table_u2u VALUES('', '$msgto', '$username', '" . time() . "', '$subject', '$message', 'outbox')");
}
...
$delete = "${$delete}";
$db->query("DELETE FROM $table_u2u WHERE msgto='$xmbuser' AND u2uid='$delete'");
}
} else {
$db->query("DELETE FROM $table_u2u WHERE msgto='$xmbuser' AND u2uid='$u2uid'");
}
